              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Gallery Details</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><a href="/gallery.html" className="text-secondary hover-text-primary">Gallery</a></li>
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Gallery Details</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row gx-5 gy-4">
              ...
              <div className="col-md-8">
                <h2 className="down-line-primary mb-4">Online Security System</h2>
                ...
                <h4 className="down-line-primary my-4">Project Details</h4>
                ...
                <ul className="mt-30">
                  <li><b className="me-2">Service Type: </b> Personal Security</li>
                  <li><b className="me-2">Client: </b> John Herrison</li>
                  <li><b className="me-2">America: </b> Newyork</li>
                  <li><b className="me-2">Started: </b> 10/20/2018</li>
                  <li><b className="me-2">End: </b> 12/31/2018</li>
                  <li><b className="me-2">Quantity : </b> 3</li>
                </ul>
                <h4 className="down-line-primary my-4">Short Description</h4>
                <p>Urna Tincidunt proin enim. Fringilla augue porta tempor. Enim natoque quis placerat quisque tempor pulvinar ultrices porta dis pharetra nulla.</p>
                <p>Justo. Nullam sodales. Dolor, facilisi hymenaeos tristique adipiscing. Iaculis. In, hymenaeos justo. Facilisi penatibus, molestie natoque suscipit at platea. Lacinia malesuada sagittis.</p>
              </div>
            </div>
          </div>
        </div>
