              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Form</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Form</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
              ...
              <div className="col">
                <form method="post" action="#">
                  <div className="row g-4">
                    ...
                    <div className="col-md-12">
                      <button className="btn btn-primary rounded-0" type="submit">Send Question</button>
                    </div>
                  </div>
                </form>
              </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6">
                <div className="from-underline-gray bg-white border border-gray p-5">
                  <form method="post" action="#">
                    <div className="row row-cols-1 g-4">
                      <div className="col">
                        <h2 className="text-uppercase text-primary mb-3">Free Consulation</h2>
                      </div>
                      <div className="col">
                        <label htmlFor="full-name" className="form-label d-block text-dark text-uppercase fs-12 fw-700">Full Name</label>
                        <input type="text" id="full-name" className="form-control" name="name" placeholder="Jason Staham" />
                      </div>
                      <div className="col">
                        <label htmlFor="phone-number" className="form-label d-block text-dark text-uppercase fs-12 fw-700">Phone Number</label>
                        <input type="text" id="phone-number" className="form-control" name="email" placeholder="Enter your phone number" />
                      </div>
                      <div className="col">
                        <label className="form-label d-block text-dark text-uppercase fs-12 fw-700">Topics</label>
                      ...
                      <div className="col">
                        <label htmlFor="message" className="form-label d-block text-dark text-uppercase fs-12 fw-700">Message</label>
                        <textarea className="form-control" id="message" name="message" rows={6} placeholder="Write your message here" defaultValue={""} />
                      </div>
                      <div className="col">
                        <button className="btn text-white bg-primary hover-bg-secondary hover-shutter-out-horizontal rounded-0 border-0 w-100" type="submit">Send Your Messenger</button>
                      </div>
                    </div>
                  </form>
                </div>
