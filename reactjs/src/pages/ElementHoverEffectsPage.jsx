export default function ElementHoverEffectsPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Hover Effects</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Hover Effects</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row">
              <div className="col">
                <h1 className="mb-5">Hover Background Effects</h1>
              </div>
            </div>
            <div className="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4">
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-sweep-to-right text-white text-center p-20 w-100">Sweep to right</a>
                <code>.hover-sweep-to-right</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-sweep-to-left text-white text-center p-20 w-100">Sweep to left</a>
                <code>.hover-sweep-to-left</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-sweep-to-bottom text-white text-center p-20 w-100">Sweep to bottom</a>
                <code>.hover-sweep-to-bottom</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-sweep-to-top text-white text-center p-20 w-100">Sweep to top</a>
                <code>.hover-sweep-to-top</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-bounce-to-right text-white text-center p-20 w-100">Bounce to right</a>
                <code>.hover-bounce-to-right</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-bounce-to-left text-white text-center p-20 w-100">Bounce to left</a>
                <code>.hover-bounce-to-left</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-bounce-to-bottom text-white text-center p-20 w-100">Bounce to bottom</a>
                <code>.hover-bounce-to-bottom</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-bounce-to-top text-white text-center p-20 w-100">Bounce to top</a>
                <code>.hover-bounce-to-top</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-radial-out text-white text-center p-20 w-100">Radial Out</a>
                <code>.hover-radial-out</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-radial-in text-white text-center p-20 w-100">Radial In</a>
                <code>.hover-radial-in</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-rectangle-in text-white text-center p-20 w-100">Rectangle In</a>
                <code>.hover-rectangle-in</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-rectangle-out text-white text-center p-20 w-100">Rectangle Out</a>
                <code>.hover-rectangle-out</code>
              </div>
              <div className="col">
                <a href="#" className="bg-primary hover-bg-secondary hover-shutter-in-horizontal text-white text-center p-20 w-100">Shutter In Horizontal</a>
                <code>.hover-shutter-in-horizontal</code>
              </div>
              <div className="col">
                <a href="#" className="bg-primary hover-bg-secondary hover-shutter-out-horizontal text-white text-center p-20 w-100">Shutter Out Horizontal</a>
                <code>.hover-shutter-out-horizontal</code>
              </div>
              <div className="col">
                <a href="#" className="bg-primary hover-bg-secondary hover-shutter-in-vertical text-white text-center p-20 w-100">Shutter in Vertical</a>
                <code>.hover-shutter-in-vertical</code>
              </div>
              <div className="col">
                <a href="#" className="bg-primary hover-bg-secondary hover-shutter-out-vertical text-white text-center p-20 w-100">Shutter out Vertical</a>
                <code>.hover-shutter-out-vertical</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-bottom-left-1 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-bottom-left-1</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-bottom-right-1 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-bottom-right-1</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-top-left-1 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-top-left-1</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-top-right-1 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-top-right-1</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-bottom-left-2 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-bottom-left-2</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-bottom-right-2 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-bottom-right-2</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-top-left-2 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-top-left-2</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-top-right-2 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-top-right-2</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-right-1 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-right-1</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-left-1 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-left-1</code>
              </div>
              <div className="col">
                <a href="#" className="rounded-pill bg-secondary hover-bg-primary bg-full-from-right-1 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-right-1</code>
              </div>
              <div className="col">
                <a href="#" className="rounded-pill bg-secondary hover-bg-primary bg-full-from-left-1 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-left-1</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-right-2 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-right-2</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary bg-full-from-left-2 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-left-2</code>
              </div>
              <div className="col">
                <a href="#" className="rounded-pill bg-secondary hover-bg-primary bg-full-from-right-2 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-right-2</code>
              </div>
              <div className="col">
                <a href="#" className="rounded-pill bg-secondary hover-bg-primary bg-full-from-left-2 text-white text-center p-20 w-100">Fade</a>
                <code>.bg-full-from-left-2</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-bg-primary hover-fade text-white text-center p-20 w-100">Fade</a>
                <code>.hover-fade</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-shadow-move-1 text-white text-center p-20 w-100">Fade</a>
                <code>.hover-shadow-move-1</code>
              </div>
            </div>
            <div className="row mt-50 mb-20">
              <div className="col">
                <h1>Border Color Effects</h1>
              </div>
            </div>
            <div className="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4">
              <div className="col">
                <a href="#" className="bg-secondary hover-underline-from-left hover-border-primary text-white text-center p-20 w-100">Underline From Left</a>
                <code>.hover-underline-from-left</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-underline-from-center hover-border-primary text-white text-center p-20 w-100">Underline From Center</a>
                <code>.hover-underline-from-center</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-underline-from-right hover-border-primary text-white text-center p-20 w-100">Underline From Right</a>
                <code>.hover-underline-from-right</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-overline-from-left hover-border-primary text-white text-center p-20 w-100">Overline From Left</a>
                <code>.hover-overline-from-left</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-overline-from-center hover-border-primary text-white text-center p-20 w-100">Overline From Center</a>
                <code>.hover-overline-from-center</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-overline-from-right hover-border-primary text-white text-center p-20 w-100">Overline From Right</a>
                <code>.hover-overline-from-right</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-underline-reveal hover-border-primary text-white text-center p-20 w-100">Underline Reveal</a>
                <code>.hover-underline-reveal</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-overline-reveal hover-border-primary text-white text-center p-20 w-100">Overline Reveal</a>
                <code>.hover-overline-reveal</code>
              </div>
              <div className="col">
                <a href="#" className="bg-secondary hover-reveal hover-border-primary text-white text-center p-20 w-100">Hover Reveal</a>
                <code>.hover-reveal</code>
              </div>
            </div>
          </div>
        </div>
