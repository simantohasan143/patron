              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Service Details</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><a href="/service.html" className="text-secondary hover-text-primary">Service</a></li>
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Service Details</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
                ...
                <div className="inner-sidebar">
                  <div className="sidebar-nav widget">
                    <ul>
                      ...
                      <li><a href="#">Office Sequrity</a></li>
                      <li><a href="#">Computer Sequrity</a></li>
              ...
              <div className="col-md-8">
                ...
                <div className="row mb-5">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <h4 className="down-line-primary text-secondary text-start mb-20">Service Advantage</h4>
                    <p>Tincidunt. Vivamus nascetur turpis pulvinar libero. Porta. Consectetuer eleifend phasellus mus nam vivamus. Consectetuer. Vel luctus dapibus nec primis nibh pharetra accumsan nisl porta. Habitant dictumst litora class,
                      porttitor primis. Tempus id consectetuer est senectus nisi nam auctor dictum venenatis quisque. Hymenaeos integer. Pede vestibulum.</p>
                  </div>
                </div>
                <div className="row row-cols-lg-3 row-cols-md-2 row-cols-1 gy-5 thumb-style-4">
                    ...
                    <div className="entry-wrapper d-flex flex-column align-items-center text-center transition-all">
                      ...
                      <div className="entry-content-wrapper pt-20">
                        <div className="entry-header">
                          <h4 className="entry-title text-secondary mb-20">Sequre Payment</h4>
                        </div>
                        <div className="entry-content">
                          <p>Dictum enim lacinia etiam pede. Vitae lacus molestie conubia dolor tristique posuere suspendisse ipsum</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col">
                    <div className="entry-wrapper d-flex flex-column align-items-center text-center transition-all">
                      ...
                      <div className="entry-content-wrapper pt-20">
                        <div className="entry-header">
                          <h4 className="entry-title text-secondary mb-20">Best Data Security</h4>
                        </div>
                        <div className="entry-content">
                          <p>Dictum enim lacinia etiam pede. Vitae lacus molestie conubia dolor tristique posuere suspendisse ipsum</p>
                        </div>
                  ...
                  <div className="col">
                    <div className="entry-wrapper d-flex flex-column align-items-center text-center transition-all">
                      ...
                      <div className="entry-content-wrapper pt-20">
                        <div className="entry-header">
                          <h4 className="entry-title text-secondary mb-20">Qualified Guardst</h4>
                        </div>
                        <div className="entry-content">
                          <p>Dictum enim lacinia etiam pede. Vitae lacus molestie conubia dolor tristique posuere suspendisse ipsum</p>
                        </div>
