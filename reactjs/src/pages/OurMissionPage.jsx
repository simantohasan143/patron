              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Our Mission</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Our Mission</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="inner-sidebar">
                  <div className="sidebar-nav widget">
                    <ul>
                      <li className="active"><a href="/our-mission.html">Our Mission</a></li>
              ...
              <div className="col-md-8">
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <span className="sub-title fs-16 ordinary-font fst-normal text-general text-start mb-20">Posuere ante tincidunt sed porta senectus fusce interdum. Dictum class semper Ornare venenatis habitant sodales. Venenatis volutpat torquent. Curae; suspendisse ligula suscipit magna. Interdum dapibus in nulla mollis
                      velit taciti mollis gravida torquent lacus lobortis volutpat elementum leo pharetra. Hac congue consequat ante laoreet consectetuer. Cum. Nulla nisl purus a. Et felis platea ligula cubilia massa ultrices leo iaculis porttitor.</span>
                  </div>
                </div>
                <div className="row mb-4">
                  <div className="col-md-12">
                    <img src="/assets/images/thumb/width-33.png" alt="image not found!" />
                  </div>
                </div>
                <div className="row g-4">
                  <div className="col-md-6">
                    <h3 className="mb-3">Progress Next Generation</h3>
                    <p>Semper viverra taciti. Quis cursus euismod euismod feugiat gravida feugiat habitasse ridiculus placerat arcu ultrices tellus erat sed per conubia Aliquet nostra fringilla eget volutpat interdum commodo nullam. Ultricies,
                      at lobortis accumsan lorem dapibus ornare. Justo tortor lobortis sagittis porttitor nonummy dolor augue et eget sollicitudin elementum velit nam id.</p>
                  </div>
                  <div className="col-md-6">
                    <h3 className="mb-3">General Public Sucurity</h3>
                    <p>Rhoncus purus neque amet per maecenas nibh. Ac nisl dui magna tortor mi fermentum. Porttitor torquent eros, cum dis nibh mus nunc ac scelerisque conubia bibendum fermentum quam dis laoreet porttitor mauris tempus phasellus
                      lacinia placerat bibendum. Justo nunc ultrices nascetur nisi. Penatibus torquent integer. Accumsan elit tempor adipiscing.</p>
                  </div>
                </div>
                <div className="row accordion right-plus border-style-none mt-5">
                  <div className="col">
                    <div id="accordion-1">
                      <div className="accordion-item bg-light">
                        <h2 className="accordion-header">
                          <button className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-1">What is the terms and condition to get a guard?</button>
                        </h2>
                        <div id="collapse-1" className="accordion-collapse collapse" data-bs-parent="#accordion-1">
                          <div className="accordion-body bg-white">
                            <p>Cubilia suspendisse, sodales Eu odio. Ad sollicitudin Mollis euismod natoque dis arcu vel fusce mattis metus taciti pellentesque netus malesuada. Vulputate nisi taciti netus leo lobortis est at leo. Tellus
                              semper amet cum condimentum lobortis pellentesque suscipit.</p>
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item bg-light">
