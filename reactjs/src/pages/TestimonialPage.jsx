              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Testimonial</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Testimonial</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
                ...
                <div className="inner-sidebar">
                  <div className="sidebar-nav widget">
                    <ul>
                      ...
                      <li className="active"><a href="/testimonial.html">Testimonial</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div className="col-md-8">
                <div className="row testimonial-style-2 g-4">
                  <div className="co-md-12">
                    <div className="entry-wrapper p-4 bg-light rounded d-flex flex-column align-items-start text-start">
                  ...
                  <div className="co-md-12">
                    <div className="entry-wrapper p-4 bg-light rounded d-flex flex-column align-items-start text-start">
                      <div className="entry-thumbnail-wrapper">
                        <div className="post-thumbnail box-80 rounded-circle overflow-hidden">
                          <img src="/assets/images/avatar/5.png" alt="Avatar Image Not Found !" />
                        </div>
                      </div>
                      <div className="entry-content-wrapper">
                        <div className="entry-content">
