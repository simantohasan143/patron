              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Career</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Career</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row g-5">
                ...
                <div className="inner-sidebar">
                  <div className="sidebar-nav widget">
                    <ul>
                      ...
                      <li className="active"><a href="/career.html">Careers</a></li>
              ...
              <div className="col-md-8">
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <span className="sub-title fs-15 ordinary-font fst-normal text-general text-start mb-30">Posuere ante tincidunt sed porta senectus fusce interdum. Dictum class semper Ornare venenatis habitant sodales. Venenatis volutpat torquent. Curae; suspendisse ligula suscipit magna. Interdum dapibus in nulla mollis velit taciti mollis gravida torquent lacus lobortis volutpat elementum leo pharetra.</span>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <h3 className="down-line-primary text-secondary text-start mb-20">Important Facts</h3>
                    <span className="sub-title fs-15 ordinary-font fst-normal text-general text-start mb-30">Maecenas hymenaeos suspendisse lobortis tempor ante. Lorem velit. Volutpat. Lacinia aliquet primis tellus platea id neque sem, ornare tortor arcu maecenas dapibus hendrerit urna mi. Hac sodales condimentum. Tempus lobortis.</span>
                  </div>
                </div>
                <div className="row row-cols-lg-2 row-cols-1 g-4 mb-30">
                  <div className="col">
                    <div className="entry-wrapper d-flex flex-row align-items-start text-start transition-all">
                      <div className="entry-thumbnail-wrapper me-3">
                        <div className="post-thumbnail overflow-hidden">
                          <i className="icon flaticon-antivirus flat-45 text-primary" />
                        </div>
                      </div>
                      <div className="entry-content-wrapper">
                        <div className="entry-header">
                          <h5 className="entry-title mb-2"><a className="text-secondary hover-text-primary" href="#">Integrity and Justic</a></h5>
                        </div>
                        <div className="entry-content">
                          <p>Tortor hac sed lobortis elit potenti lacus facilisis. Ac dictumst tristique. Curae; consectetuer facilisis curabitur mauris morbi etiam potenti Amet.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col">
                    <div className="entry-wrapper d-flex flex-row align-items-start text-start transition-all">
                      <div className="entry-thumbnail-wrapper me-3">
                        <div className="post-thumbnail overflow-hidden">
                          <i className="icon flaticon-money flat-45 text-primary" />
                        </div>
                      </div>
                      <div className="entry-content-wrapper">
                        <div className="entry-header">
                          <h5 className="entry-title mb-2"><a className="text-secondary hover-text-primary" href="#">Indemnity and Guarantor</a></h5>
                        </div>
                        <div className="entry-content">
                          <p>Tortor hac sed lobortis elit potenti lacus facilisis. Ac dictumst tristique. Curae; consectetuer facilisis curabitur mauris morbi etiam potenti Amet.</p>
                        </div>
                  ...
                  <div className="col">
                    <div className="entry-wrapper d-flex flex-row align-items-start text-start transition-all">
                      <div className="entry-thumbnail-wrapper me-3">
                        <div className="post-thumbnail overflow-hidden">
                          <i className="icon flaticon-partner flat-45 text-primary" />
                        </div>
                      </div>
                      <div className="entry-content-wrapper">
                        <div className="entry-header">
                          <h5 className="entry-title mb-2"><a className="text-secondary hover-text-primary" href="#">Friendly Environment</a></h5>
                        </div>
                        <div className="entry-content">
                          <p>Tortor hac sed lobortis elit potenti lacus facilisis. Ac dictumst tristique. Curae; consectetuer facilisis curabitur mauris morbi etiam potenti Amet.</p>
                        </div>
                  ...
                  <div className="col">
                    <div className="entry-wrapper d-flex flex-row align-items-start text-start transition-all">
                      <div className="entry-thumbnail-wrapper me-3">
                        <div className="post-thumbnail overflow-hidden">
                          <i className="icon flaticon-motivation flat-45 text-primary" />
                        </div>
                      </div>
                      <div className="entry-content-wrapper">
                        <div className="entry-header">
                          <h5 className="entry-title mb-2"><a className="text-secondary hover-text-primary" href="#">Possitive Motiivation</a></h5>
                        </div>
                        <div className="entry-content">
                          <p>Tortor hac sed lobortis elit potenti lacus facilisis. Ac dictumst tristique. Curae; consectetuer facilisis curabitur mauris morbi etiam potenti Amet.</p>
                        </div>
                ...
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <h3 className="down-line-primary text-secondary text-start mb-20">Job Opportunity</h3>
                    <span className="sub-title fs-15 ordinary-font fst-normal text-general text-start mb-50">Integer lacinia mus sociosqu. Velit enim interdum dictumst. Sed leo inceptos egestas diam diam luctus. Class lobortis nam. Quam natoque duis hymenaeos torquent curabitur sit hymenaeos laoreet felis, curabitur vel amet aenean aliquet suscipit aenean fermentum, tincidunt purus interdum id.</span>
                  </div>
                </div>
                    ...
                    <div id="accordion-1">
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          <button className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-1">Executive Officer ( 3 Person )</button>
                        </h2>
                          ...
                          <div className="accordion-body bg-white">
                            <div className="row row-cols-sm-2 row-cols-1 g-4">
                              <div className="col">
                                ...
                                <p>Bibendum proin conubia vulputate diam mi hac mus adipiscing ut euismod diam condimentum volutpat feugiat diam blandit inceptos. Facilisis pharetra.</p>
                                <span className="text-primary d-block mt-3">Job Type :</span>
                                <p>Full - Time Posiotion</p>
                                <span className="text-primary d-block mt-3">Salary Range :</span>
                                <p>$4K - $5K (From Starting)</p>
                              </div>
                              <div className="col">
                                <span className="text-primary">Qualification :</span>
                                <ul>
                                  <li>Amet ridiculus sit ullamcorper nibh pede ut cras. </li>
                                  <li>Molestie rhoncus consequat erat ultrices nullam.</li>
                                  <li>Adipiscing rhoncus fermentum elementum turpis.</li>
                                  <li>Dictumst, arcu pellentesque.</li>
                                  <li>Potenti condimentum pede adipiscing malesuada.</li>
                                </ul>
                                <span className="text-primary d-block mt-3">Location :</span>
                                <p>Head Office, San Franciso, USA</p>
                                <a className="btn btn-primary d-block mt-3" href="/application.html">Apply now</a>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header">
                          <button className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-2">HRM Depeartment ( 1 Person )</button>
                        </h2>
