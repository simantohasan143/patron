export default function ElementSliderPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Slider</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Slider</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row">
              <div className="col-6">
                <div className="bg-primary text-white d-table px-3 py-1 mb-4 rounded-3">Welcome To Patron.</div>
                <h1 className="mb-4 display-1 fw-500">Get more <br /> Impact Fasted</h1>
                <div className="fs-16">
                  <p>Tinkety tonk old fruit baking cakes cobblers happy days argy-bargy up the duff excuse my french fanny around.</p>
                </div>
                <div className="mt-4">
                  <a href="#" className="btn btn-outline-primary rounded-10">See what's New</a>
                </div>
              </div>
              <div className="col-6">
                <div className="scene">
                  <img data-depth="0.2" src="/assets/images/clipart/1.png" alt="photo" />
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="full-row" style={{background: 'url(/assets/images/background/5.png) no-repeat center/cover'}}>
          <div className="container">
            <div className="row">
              <div className="col-8">
                <div className="py-8">
                  <div className="text-general d-table text-uppercase fw-600">consulte company</div>
                  <h1 className="mb-5 display-1 fw-500">Clever <span className="text-success fw-700">Investing</span> Make Your Money Grow</h1>
                  <div className="fs-16">
                  ...
                  <div className="mt-5 d-table">
                    <a href="#" className="text-white text-uppercase fw-600 btn bg-primary hover-shutter-out-horizontal hover-bg-secondary rounded-0 border-0">Work With Us</a>
                  </div>
                </div>
              </div>
            </div>
