  ...
  return (
    <>
      <div id="page-wrapper">
                ...
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  ...
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Products</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        {/* <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1 g-4 product-style-3 e-img-bg-light transition-all">
        <div class="col">
            <div class="product type-product">
                <div class="product-wrapper">
                    <div class="product-image">
                        <span class="on-sale">Sale!</span>
                        <a href="/shop-single.html" class="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/products/1.png" alt="Product Image"></a>
                    </div>
                    <div class="product-info">
                        <div class="product-cats">
                            <a href="#">Lamp Shade</a>
                        </div>
                        <h3 class="product-title"><a href="/shop-single.html" target="_self">Gray Color Chair</a></h3>
                        <div class="price-wrap">
                            <div class="product-price">
                                <span class="price">
                                    <del><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>100.00</bdi></span></del> 
                        ...
                        <div class="fancy-star-rating">
                            <div class="rating-wrap">
                                <div class="fancy-rating good"><span>★★★★★</span></div>
                            </div>
                        </div>
            ...
            <div className="row mb-4">
              <div className="col-xl-6 col-md-7">
                <div className="row justify-content-start">
                  <div className="col-lg-12">
                    <span className="tagline text-primary text-start fs-14 ordinary-font fw-500 mb-1">Best Sale</span>
                    <h4 className="down-line text-secondary text-start mb-30">Most Popular Product</h4>
                  </div>
                </div>
              </div>
              <div className="col-xl-6 col-md-5">
                <a href="#" className="btn-link btn-hover-downline-1 text-dark float-md-end y-center position-relative">See All Product <i className="fas fa-caret-right" /></a>
              </div>
            </div>
          </div>
          <div className="container">
            <div className="row e-bg-white e-hover-image-zoom e-title-text-general e-hover-title-text-primary e-info-center product-style-1 product-grid">
              <div className="col-lg-12">
                <div className="product-carousel owl-mx-4">
                  <div className="4block-carousel owl-carousel owl-nav-disable owl-dot-round owl-dot-bottom-center owl-dot-active-pill-primary auto-play-on">
                    <div className="item">
                      <div className="product type-product">
                        <div className="product-wrapper">
                          <div className="product-image">
                            <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/products/1.png" alt="Product Image" /></a>
                          </div>
                          <div className="product-info">
                            <div className="product-cats">
                              <a href="#">Lamp Shade</a>
                            </div>
                            <h3 className="product-title"><a href="/shop-single.html" target="_self">Gray Color Chair</a></h3>
                            <div className="price-wrap">
                              <div className="product-price">
                                <span className="price">
                                  <ins><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>70.00</bdi>
                                    </span>
                                  </ins>
                                </span>
                              </div>
                    ...
                    <div className="item">
                      <div className="product type-product">
                        <div className="product-wrapper">
                          <div className="product-image">
                            <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/products/2.png" alt="Product Image" /></a>
                          </div>
                          <div className="product-info">
                            <div className="product-cats">
                              <a href="#">Lamp Shade</a>
                    ...
                    <div className="item">
                      <div className="product type-product">
                        <div className="product-wrapper">
                          <div className="product-image">
                            <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/products/3.png" alt="Product Image" /></a>
                          </div>
                          <div className="product-info">
                            <div className="product-cats">
                              <a href="#">Lamp Shade</a>
                    ...
                    <div className="item">
                      <div className="product type-product">
                        <div className="product-wrapper">
                          <div className="product-image">
                            <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/products/4.png" alt="Product Image" /></a>
                          </div>
                          <div className="product-info">
                            <div className="product-cats">
                              <a href="#">Lamp Shade</a>
                    ...
                    <div className="item">
                      <div className="product type-product">
                        <div className="product-wrapper">
                          <div className="product-image">
                            <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/products/5.png" alt="Product Image" /></a>
                          </div>
                          <div className="product-info">
                            <div className="product-cats">
                              <a href="#">Lamp Shade</a>
        ...
        {/*============================== Product Style 1 Section End ==============================*/}
        {/*============================== Product Style 3 Section Start ==============================*/}
        <div className="full-row bg-white">
          <div className="container">
            <div className="row row-cols-lg-4 row-cols-md-2 row-cols-1 g-4 product-style-3 e-img-bg-light transition-all">
              <div className="col">
                <div className="product type-product">
                  <div className="product-wrapper">
                    <div className="product-image">
                    ...
                    <div className="product-info">
                      <h3 className="product-title"><a href="/shop-single.html" target="_self">Blooth Headphones</a>
                      </h3>
                      <div className="price-wrap">
                        <div className="product-price">
        ...
        {/*============================== Product Style 3 Section End ==============================*/}
        {/*============================== Product Style 2 Section Start ==============================*/}
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9 wow animate__ animated animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                <h2 className="text-white text-center mb-50">Check out other main products</h2>
              </div>
            </div>
          </div>
          <div className="container">
            <div className="row row-cols-lg-6 row-cols-md-3 row-cols-sm-2 row-cols-1 gy-4 e-title-text-white e-info-center product-style-2 product-grid">
              <div className="col">
                <div className="product type-product">
                  <div className="product-wrapper gradient-bg-1">
                    <div className="product-image">
                      <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/extra/1.png" alt="Product Image" /></a>
                    </div>
                    <div className="product-info">
                      <h6 className="product-title"><a href="/shop-single.html" target="_self">Web Hosting</a></h6>
                      <div className="price-wrap">
                        <div className="product-price">
                          <span className="price">
                            <span>From</span>
                            <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>2</bdi>
                            </span>
                            <span>/mo</span>
                          </span>
                        </div>
              ...
              <div className="col">
                <div className="product type-product">
                  <div className="product-wrapper gradient-bg-2">
                    <div className="product-image">
                      <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/extra/1.png" alt="Product Image" /></a>
                    </div>
                    <div className="product-info">
                      <h6 className="product-title"><a href="/shop-single.html" target="_self">VPS</a></h6>
                      <div className="price-wrap">
                        <div className="product-price">
                          <span className="price">
                            <span>From</span>
                            <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>5</bdi>
                            </span>
                            <span>/mo</span>
                          </span>
                        </div>
              ...
              <div className="col">
                <div className="product type-product">
                  <div className="product-wrapper gradient-bg-3">
                    <div className="product-image">
                      <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/extra/1.png" alt="Product Image" /></a>
                    </div>
                    <div className="product-info">
                      <h6 className="product-title"><a href="/shop-single.html" target="_self">Dedicate</a></h6>
                      <div className="price-wrap">
                        <div className="product-price">
                          <span className="price">
                            <span>From</span>
                            <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>15</bdi>
                            </span>
                            <span>/mo</span>
                          </span>
                        </div>
              ...
              <div className="col">
                <div className="product type-product">
                  <div className="product-wrapper gradient-bg-4">
                    <div className="product-image">
                      <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/extra/1.png" alt="Product Image" /></a>
                    </div>
                    <div className="product-info">
                      <h6 className="product-title"><a href="/shop-single.html" target="_self">Wordpress</a></h6>
                      <div className="price-wrap">
                        <div className="product-price">
                          <span className="price">
                            <span>From</span>
                            <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>25</bdi>
                            </span>
                            <span>/mo</span>
                          </span>
                        </div>
              ...
              <div className="col">
                <div className="product type-product">
                  <div className="product-wrapper gradient-bg-5">
                    <div className="product-image">
                      <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/extra/1.png" alt="Product Image" /></a>
                    </div>
                    <div className="product-info">
                      <h6 className="product-title"><a href="/shop-single.html" target="_self">Cloud</a></h6>
                      <div className="price-wrap">
                        <div className="product-price">
                          <span className="price">
                            <span>From</span>
                            <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>50</bdi>
                            </span>
                            <span>/mo</span>
                          </span>
                        </div>
              ...
              <div className="col">
                <div className="product type-product">
                  <div className="product-wrapper gradient-bg-6">
                    <div className="product-image">
                      <a href="/shop-single.html" className="woocommerce-LoopProduct-link" target="_self"><img src="/assets/images/extra/1.png" alt="Product Image" /></a>
                    </div>
                    <div className="product-info">
                      <h6 className="product-title"><a href="/shop-single.html" target="_self">Security</a></h6>
                      <div className="price-wrap">
                        <div className="product-price">
                          <span className="price">
                            <span>From</span>
                            <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>99</bdi>
                            </span>
                            <span>/mo</span>
                          </span>
                        </div>
