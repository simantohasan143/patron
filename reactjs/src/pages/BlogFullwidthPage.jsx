  ...
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">News Full Width</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">News Full Width</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        {/*============================== News Section Start ==============================*/}
        <div className="full-row px-sm-5">
