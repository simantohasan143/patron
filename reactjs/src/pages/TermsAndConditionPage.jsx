              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Terms &amp; Condition</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Terms &amp; Condition</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div className="row g-5">
              <div className="col-lg-4 col-md-5">
                <div className="bg-light p-5">
                  <ul className="list-number list-color-general hover-list-color-primary d-flex flex-column gap-0">
              ...
              <div className="col-lg-8 col-md-7">
                <h2 className="down-line-primary mb-3">User Agreement</h2>
