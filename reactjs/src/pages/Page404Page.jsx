              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">404</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">404</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div className="row justify-content-center">
              <div className="col-md-6">
                <div className="text-center">
                  <span className="fa fa-exclamation-triangle fa-4x text-primary" />
                  ...
                  <a className="btn btn-secondary mt-5 rounded-0" href="#">Return to home</a>
                </div>
              </div>
            </div>
          </div>
