    ...
    <>
      <div id="page-wrapper">
                ...
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  ...
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Team Member</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4 gy-5 team-style-1">
              <div className="col">
                ...
                <div className="entry-wrapper d-flex flex-column align-items-center text-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      ...
                      <div className="position-absolute xy-center w-100 p-4">
                        <h6 className="text-center overflow-hidden"><a className="text-white first-push-up" href="/profile-details.html">Jonathan Rudall</a></h6>
                        <div className="text-white text-center overflow-hidden"><span className="second-push-up">( Apartment Manager )</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary hover-text-primary" href="/profile-details.html">Jonathan Rudall</a></h5>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="entry-wrapper d-flex flex-column align-items-center text-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      ...
                      <div className="position-absolute xy-center w-100 p-4">
                        <h6 className="text-center overflow-hidden"><a className="text-white first-push-up" href="/profile-details.html">Jonathan Cumbrae</a></h6>
                        <div className="text-white text-center overflow-hidden"><span className="second-push-up">( Apartment Manager )</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary hover-text-primary" href="/profile-details.html">Jonathan Cumbrae</a></h5>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="entry-wrapper d-flex flex-column align-items-center text-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      ...
                      <div className="position-absolute xy-center w-100 p-4">
                        <h6 className="text-center overflow-hidden"><a className="text-white first-push-up" href="/profile-details.html">Flynn Sawers</a></h6>
                        <div className="text-white text-center overflow-hidden"><span className="second-push-up">( Apartment Manager )</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary hover-text-primary" href="/profile-details.html">Flynn Sawers</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/height-17.png" alt="Image not found !" />
                      <div className="position-absolute xy-center w-100 p-4">
                        <h6 className="text-center overflow-hidden"><a className="text-white first-push-up" href="/profile-details.html">Ashton St Julian</a></h6>
                        <div className="text-white text-center overflow-hidden"><span className="second-push-up">( Apartment Manager )</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary hover-text-primary" href="/profile-details.html">Ashton St Julian</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/height-18.png" alt="Image not found !" />
                      <div className="position-absolute xy-center w-100 p-4">
                        <h6 className="text-center overflow-hidden"><a className="text-white first-push-up" href="/profile-details.html">Brock Proud</a></h6>
                        <div className="text-white text-center overflow-hidden"><span className="second-push-up">( Apartment Manager )</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary hover-text-primary" href="/profile-details.html">Brock Proud</a></h5>
                    </div>
                  </div>
                </div>
              </div>
