              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">News</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">News</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row gy-5">
              {/*============================== Sidebar start ==============================*/}
              <div id="secondary" className="widget-area col-lg-4 order-lg-2">
              ...
              <div className="col-lg-8 order-lg-1">
                <div className="row row-cols-md-2 row-cols-1 g-4 blog-style-1 entry-meta-divider-line transition-all">
                  <div className="col">
