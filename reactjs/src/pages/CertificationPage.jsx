              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Certification</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Certification</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
                ...
                <div className="inner-sidebar">
                  <div className="sidebar-nav widget">
                    <ul>
                      ...
                      <li className="active"><a href="/certification.html">Certification</a></li>
              ...
              <div className="col-md-8">
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <h2 className="down-line-primary text-secondary text-start mb-30">Certifications and Awards</h2>
                    <span className="sub-title fs-14 ordinary-font fst-normal text-general text-start mb-30">Posuere ante tincidunt sed porta senectus fusce interdum. Dictum class semper Ornare venenatis habitant sodales. Venenatis volutpat torquent. Curae; suspendisse ligula suscipit magna. Interdum dapibus in nulla mollis velit taciti mollis gravida torquent lacus lobortis volutpat elementum leo pharetra. Hac congue consequat ante laoreet consectetuer. Cum. Nulla nisl purus a. Et felis platea ligula cubilia massa ultrices leo iaculis porttitor.</span>
                  </div>
                </div>
                <div className="row row-cols-1 g-5">
                  <div className="col">
                    <div className="row g-4">
                      <div className="col-lg-4 col-md-6">
                        <img src="/assets/images/thumb/square-5.png" alt="image not found" />
                      </div>
                      <div className="col-lg-8 col-md-6">
                        <h4 className="mb-3"><a href="#" className="text-secondary hover-text-primary">Best Security company awards - 2017</a></h4>
                        <ul className="mb-4">
                          <li><b>Award Date:</b> 10 April, 2017</li>
                          <li><b>Location:</b> Hilton Conferance Center, Calefonia</li>
                        </ul>
                        <p>Enim ipsum. Cras parturient fermentum aliquet luctus commodo placerat tristique purus aenean neque tellus class aliquet volutpat fusce magnis netus proin tortor sapien phasellus lorem nulla commodo Enim.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col">
                    <div className="row g-4">
                      <div className="col-lg-4 col-md-6">
                        <img src="/assets/images/thumb/square-6.png" alt="image not found" />
                      </div>
                      <div className="col-lg-8 col-md-6">
                        <h4 className="mb-3"><a href="#" className="text-secondary hover-text-primary">Certification and Awards after Training</a></h4>
                        <ul className="mb-4">
                          <li><b>Award Date:</b> 10 April, 2017</li>
                          <li><b>Location:</b> Hilton Conferance Center, Calefonia</li>
                        </ul>
                  ...
                  <div className="col">
                    <div className="row g-4">
                      ...
                      <div className="col-lg-8 col-md-6">
                        <h4 className="mb-3"><a href="#" className="text-secondary hover-text-primary">International Security Councle Certification</a></h4>
                        <ul className="mb-4">
                          <li><b>Award Date:</b> 10 April, 2017</li>
                          <li><b>Location:</b> Hilton Conferance Center, Calefonia</li>
                        </ul>
                  ...
                  <div className="col">
                    <div className="row g-4">
                      <div className="col-lg-4 col-md-6">
                        <img src="/assets/images/thumb/square-8.png" alt="image not found" />
                      </div>
                      <div className="col-lg-8 col-md-6">
                        <h4 className="mb-3"><a href="#" className="text-secondary hover-text-primary">Homeland Security Association Certificated</a></h4>
                        <ul className="mb-4">
                          <li><b>Award Date:</b> 10 April, 2017</li>
                          <li><b>Location:</b> Hilton Conferance Center, Calefonia</li>
                        </ul>
