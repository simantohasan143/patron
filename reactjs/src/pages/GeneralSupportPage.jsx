  ...
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">General Support</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">General Support</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        {/*============================== General Support Section Start ==============================*/}
        <div className="full-row bg-gray">
          <div className="container">
            <div className="row g-5 mb-5">
              <div className="col-md-6">
                <h2 className="mb-3">Hello, How we can help?</h2>
                <span>Search for a question and topics</span>
              </div>
              <div className="col-md-6">
                <form action="#" method="post">
                  <div className="row">
                    <div className="col-lg-12">
                      <input type="text" className="form-control bg-light" name="search" placeholder="Search what you are looking for....." />
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div className="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 g-4">
              <div className="col">
                <div className="support-thumbnail p-4 bg-white shadow-sm">
                  <span className="flaticon-support flat-45 text-primary" />
                  <h5 className="py-3"><a href="#" className="text-secondary">General Question</a></h5>
                  <hr />
                  <ul className="list-color-general">
                    <li><a href="#">Speciality of the theme</a></li>
                    <li><a href="#">Manage your settings</a></li>
                    <li><a href="#">Responsive and validation</a></li>
                    <li><a href="#">Console error issue</a></li>
                  </ul>
                  <hr />
                  <a href="#"><i className="fas fa-file-alt" /> 20 Topics</a>
                </div>
              </div>
              <div className="col">
                <div className="support-thumbnail p-4 bg-white shadow-sm">
                  <span className="flaticon-settings flat-45 text-primary" />
                  <h5 className="py-3"><a href="#" className="text-secondary">Techinical Support</a></h5>
                  <hr />
                  <ul className="list-color-general">
                    <li><a href="#">Access another computer</a></li>
                    <li><a href="#">Purchase code</a></li>
                    <li><a href="#">Theme license</a></li>
                    <li><a href="#">Theme performance</a></li>
                  </ul>
                  <hr />
                  <a href="#"><i className="fas fa-file-alt" /> 20 Topics</a>
                </div>
              ...
              <div className="col">
                <div className="support-thumbnail p-4 bg-white shadow-sm">
                  <span className="flaticon-conversation flat-45 text-primary" />
                  <h5 className="py-3"><a href="#" className="text-secondary">Complain and Objection</a></h5>
                  <hr />
                  <ul className="list-color-general">
                    <li><a href="#">Password recovery</a></li>
                    <li><a href="#">Profile varifivation</a></li>
                    <li><a href="#">Change my informations</a></li>
                    <li><a href="#">Second step varification</a></li>
                  </ul>
                  <hr />
                  <a href="#"><i className="fas fa-file-alt" /> 20 Topics</a>
                </div>
              ...
              <div className="col">
                <div className="support-thumbnail p-4 bg-white shadow-sm">
                  <span className="flaticon-shopping-1 flat-45 text-primary" />
                  <h5 className="py-3"><a href="#" className="text-secondary">Purchase Support</a></h5>
                  <hr />
                  <ul className="list-color-general">
                    <li><a href="#">Password recovery</a></li>
                    <li><a href="#">Profile varifivation</a></li>
              ...
              <div className="col">
                <div className="support-thumbnail p-4 bg-white shadow-sm">
                  <span className="flaticon-work flat-45 text-primary" />
                  <h5 className="py-3"><a href="#" className="text-secondary">Service Information</a></h5>
                  <hr />
                  <ul className="list-color-general">
                    <li><a href="#">Password recovery</a></li>
                    <li><a href="#">Profile varifivation</a></li>
              ...
              <div className="col">
                <div className="support-thumbnail p-4 bg-white shadow-sm">
                  <span className="flaticon-id-card flat-45 text-primary" />
                  <h5 className="py-3"><a href="#" className="text-secondary">Payment Garentee</a></h5>
                  <hr />
                  <ul className="list-color-general">
                    <li><a href="#">Password recovery</a></li>
                    <li><a href="#">Profile varifivation</a></li>
              ...
              <div className="col">
                <div className="support-thumbnail p-4 bg-white shadow-sm">
                  <span className="flaticon-user-1 flat-45 text-primary" />
                  <h5 className="py-3"><a href="#" className="text-secondary">Account Support</a></h5>
                  <hr />
                  <ul className="list-color-general">
                    <li><a href="#">Password recovery</a></li>
                    <li><a href="#">Profile varifivation</a></li>
              ...
              <div className="col">
                <div className="support-thumbnail p-4 bg-white shadow-sm">
                  <span className="flaticon-touch flat-45 text-primary" />
                  <h5 className="py-3"><a href="#" className="text-secondary">Getting Started</a></h5>
                  <hr />
                  <ul className="list-color-general">
                    <li><a href="#">Password recovery</a></li>
                    <li><a href="#">Profile varifivation</a></li>
