            ...
            <div className="row">
              <div className="col-6">
                <div className="row justify-content-center align-items-start">
                  <div className="col-lg-12">
                    <span className="tagline ordinary-font fw-500 fst-normal text-left text-primary mb-10">About Our Company</span>
                  </div>
                </div>
                <div className="row justify-content-center align-items-start">
                  <div className="col-lg-12">
                    <h2 className="down-line down-line-secondary highlight-font fw-600 fst-normal text-left text-secondary mb-30">We Have 15 Years of Experience on People Self Dependence Training</h2>
                  </div>
                </div>
              </div>
            </div>
