export default function ElementTypographyPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Typography</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Typography</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            ...
            <div className="row justify-content-start mt-5">
              <div className="col-lg-8">
                <span className="tagline text-primary text-start mb-10">What We Offer</span>
                <h1 className="down-line text-secondary text-start mb-30">Our Awesome Services</h1>
                <span className="sub-title fs-18 ordinary-font text-start mb-50">Aliquam litora ad sociosqu turpis etiam tempus egestas nulla diam tempus mollis ante ornare consectetuer dictum sodales adipiscing ultricies Elit semper Integer felis lectus.</span>
              </div>
            </div>
            <div className="row justify-content-end mt-5">
              <div className="col-lg-8">
                <span className="tagline text-primary text-end mb-10">What We Offer</span>
                <h1 className="down-line text-secondary text-end mb-30">Our Awesome Services</h1>
                <span className="sub-title fs-18 ordinary-font text-end mb-50">Aliquam litora ad sociosqu turpis etiam tempus egestas nulla diam tempus mollis ante ornare consectetuer dictum sodales adipiscing ultricies Elit semper Integer felis lectus.</span>
              </div>
            </div>
            <div className="row justify-content-start mt-5">
              <div className="col-lg-9">
                <span className="tagline text-general text-start text-uppercase mb-10">Latest Projects</span>
                <h1 className="text-secondary text-start mb-0">See Our <span className="fw-700 text-primary">Successful Businesses</span></h1>
              </div>
              <div className="col-lg-3">
                <div className="d-flex align-items-center justify-content-end h-100">
                  <a href="#" className="cases text-uppercase">All Cases <i className="fas fa-chevron-right" /></a>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <h1>This is hedaline one style.</h1>
                <h2>This is hedaline two style.</h2>
                <h3>This is hedaline three style.</h3>
                <h4>This is hedaline four style.</h4>
                <h5>This is hedaline five style.</h5>
                <h6>This is hedaline six style.</h6>
              </div>
            </div>
          </div>
        </div>
