export default function ElementTabPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Tab</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Tab</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        {/*============================== Nav Tab 1 Section Start ==============================*/}
        <div className="full-row">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <ul className="nav nav-pills nav-tab-1 mb-3">
                  <li className="nav-item">
                    <a href="#pills1-knowledge" className="nav-link active" data-bs-toggle="pill">Share Knowledge</a>
                  </li>
                  <li className="nav-item">
                    <a href="#pills1-service" className="nav-link" data-bs-toggle="pill">Customer Service</a>
                  </li>
                  <li className="nav-item">
                    <a href="#pills1-media" className="nav-link" data-bs-toggle="pill">Social Media</a>
                  </li>
                  <li className="nav-item">
                    <a href="#pills1-financial" className="nav-link" data-bs-toggle="pill">Financial</a>
                  </li>
                </ul>
                <div className="tab-content mt-5">
                  <div className="tab-pane fade show active" id="pills1-knowledge">
                    <div className="bg-gray p-40">
                      <div className="row align-items-center">
                        <div className="col-lg-5">
                          <img src="/assets/images/clipart/1.png" alt />
                        </div>
                        <div className="col-lg-6 offset-lg-1">
                          ...
                          <div className="d-flex justify-content-between mt-40">
                            <div className="entry-wrapper d-flex flex-row align-items-center text-start">
                              <div className="entry-thumbnail-wrapper me-3">
                                <div className="post-thumbnail box-40 overflow-hidden">
                                  <img src="/assets/images/icon/5.png" className="w-100" alt />
                                </div>
                              </div>
                              <div className="entry-content-wrapper">
                                <div className="entry-header">
                                  <h4 className="entry-title mb-0">Acquisitions Finance Consulting</h4>
                                </div>
                              </div>
                            </div>
                            <div className="entry-wrapper d-flex flex-row align-items-center text-start">
                          ...
                          <div className="mt-5"><a className="btn btn-primary-filter" href="#">Get Started</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="tab-pane fade" id="pills1-service">
                    <div className="bg-gray p-40">
                      <div className="row align-items-center">
                        <div className="col-lg-5">
                          <img src="/assets/images/clipart/1.png" alt />
                  ...
                  <div className="tab-pane fade" id="pills1-media">
                    <div className="bg-gray p-40">
                      <div className="row align-items-center">
                        <div className="col-lg-5">
                          <img src="/assets/images/clipart/1.png" alt />
                  ...
                  <div className="tab-pane fade" id="pills1-financial">
                    <div className="bg-gray p-40">
                      <div className="row align-items-center">
                        <div className="col-lg-5">
                          <img src="/assets/images/clipart/1.png" alt />
