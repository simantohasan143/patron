              ...
              <div className="row">
                <div className="col-lg-12">
                  <nav className="navbar navbar-expand-lg navbar-light text-uppercase nav-dark nav-primary-hover nav-primary-active fw-500">
                    <a className="navbar-brand d-lg-none" href="#"><img className="nav-logo" src="/assets/images/logo/2.png" alt="Patron" /></a>
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Cart</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Cart</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div className="row">
              <div id="primary" className="content-area col-md-12 check-system">
                <div className="grid-cols row g-4 row-cols-1">
                  <article id="post-8" className="col">
                    <div className="entry-content">
                      <div className="woocommerce">
                        <div className="woocommerce-cart-wrapper row gy-5">
                          <form className="woocommerce-cart-form col-lg-8" action="#" method="post">
                            <div className="woocommerce-cart-inner">
                                ...
                                <tbody>
                                  <tr className="woocommerce-cart-form__cart-item cart_item">
                                    <td className="product-thumbnail">
                                      <a href="#"><img src="/assets/images/thumb/square-2.png" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt /></a>
                                    </td>
                                    <td className="product-name"><a href="#">Bluva Analog Watch</a></td>
                                    ...
                                    <td className="product-quantity">
                                      <div className="quantity">
                                        ...
                                        <label className="screen-reader-text" htmlFor="number-1">Bluva Analog Watch quantity</label>
                                        <input type="number" id="number-1" className="input-text qty text" name="cart" title="Qty" defaultValue={1} />
                                  ...
                                  <tr className="woocommerce-cart-form__cart-item cart_item">
                                    ...
                                    <td className="product-quantity">
                                      <div className="quantity">
                                        <input type="button" defaultValue="-" className="minus quantity-button quantity-down" />
                                        <label className="screen-reader-text" htmlFor="number-2">Bluva Analog Watch quantity</label>
                                        <input type="number" id="number-2" className="input-text qty text" name="cart" title="Qty" defaultValue={1} />
                                        <input type="button" defaultValue="+" className="plus quantity-button quantity-down" />
                                      </div>
                                    </td>
                                    <td className="product-subtotal" data-title="Subtotal">
                                  ...
                                  <tr className="woocommerce-cart-form__cart-item cart_item">
                                    ...
                                    <td className="product-quantity">
                                      <div className="quantity">
                                        <input type="button" defaultValue="-" className="minus quantity-button quantity-down" />
                                        <label className="screen-reader-text" htmlFor="number-3">Bluva Analog Watch quantity</label>
                                        <input type="number" id="number-3" className="input-text qty text" name="cart" title="Qty" defaultValue={1} />
                                        <input type="button" defaultValue="+" className="plus quantity-button quantity-down" />
                                      </div>
                                    </td>
                                    <td className="product-subtotal" data-title="Subtotal">
                                ...
                                <div className="row g-4">
                                  <div className="col-sm-8 col-md-7">
                                    <div className="coupon">
                                      <label htmlFor="coupon_code">Coupon:</label> <input type="text" name="coupon_code" className="input-text" id="coupon_code" defaultValue placeholder="Coupon code" /> <button type="submit" className="button" name="apply_coupon" value="Apply coupon">Apply coupon</button>
                                    </div>
                                  </div>
                                  <div className="col-sm-4 col-md-5 text-sm-end">
                                    <button type="submit" className="button" name="update_cart" value="Update cart" disabled aria-disabled="true">Update cart</button>
                                    <input type="hidden" id="woocommerce-cart-nonce" name="woocommerce-cart-nonce" defaultValue="185b494eae" /><input type="hidden" name="_wp_http_referer" defaultValue="/default/cart/" />
                                  </div>
                                </div>
                              </div>
                            </div>
                          </form>
                          <div className="cart-collaterals col-lg-4">
                              ...
                              <table className="shop_table shop_table_responsive">
                                <tbody>
                                  <tr className="cart-subtotal">
                                    <th>Subtotal</th>
                                    <td><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>197.00</bdi>
                                      </span>
                                    </td>
                                  </tr>
                                  <tr className="order-total">
                                    <th>Total</th>
                                    <td><strong><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>197.00</bdi></span></strong> </td>
                                  </tr>
                                </tbody>
                              </table>
