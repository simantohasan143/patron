export default function ElementTestimonialsPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Testimonials</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Testimonials</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 wow animate__ animate__fadeIn animated" data-wow-delay="100ms" data-wow-duration="1000ms">
                <span className="tagline text-uppercase text-primary text-center mb-10">Testimonial</span>
                <h2 className="text-secondary text-center mb-30">What people says about us</h2>
                <span className="sub-title fs-15 ordinary-font fst-normal text-general text-center mb-50">Simple. Powerful. Relaiable. Fastest. Winning awards support. Hack-free protection. Better pricing. And many more featured that made many people love us.</span>
              </div>
            </div>
            <div className="row testimonial-style-1 owl-mx-4">
              <div className="col-12">
                <div className="testimonials 3block-carousel owl-carousel owl-nav-disable owl-dot-round owl-dot-bottom-center owl-dot-active-pill-primary autoplay-off">
                  <div className="item">
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-7">
                ...
                <h1 className="down-line text-secondary text-center mb-50 ">Testimonial</h1>
              </div>
            </div>
            <div className="row justify-content-center text-center testimonial-style-2">
              <div className="col-md-10 col-lg-9">
                <div className="single-carousel owl-carousel owl-nav-disable owl-dot-round owl-dot-bottom-center owl-dot-active-pill-primary autoplay-off">
                  <div className="item">
                    <div className="entry-wrapper d-flex flex-column align-items-center text-center">
                      <div className="entry-thumbnail-wrapper">
                      ...
                      <div className="entry-content-wrapper pt-4">
                        <div className="entry-header">
                          <div className="text-secondary">
                            <span className="rank">CEO ( Grodins Group )</span>
                          </div>
                        </div>
                        <div className="entry-content">
                          <div className="quotation">
                            <i className="flaticon-text-quotes flat-45 text-primary" />
                          </div>
                          <p>Interdum laoreet. Habitasse senectus blandit sodales nascetur quis laoreet interdum, aliquet natoque, libero. Quam. Iaculis nulla quam elit, quis blandit rhoncus ultricies justo vel. Facilisis taciti. Fusce
                            ultrices malesuada turpis hac Auctor mattis imperdiet iaculis molestie curae; cum accumsan placerat justo sem.</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="container">
            <div className="row justify-content-start">
              <div className="col-lg-8">
                <span className="tagline text-primary text-start mb-1">Testimonial</span>
                <h3 className="down-line text-white text-start mb-50">What Client Say</h3>
              </div>
            </div>
            <div className="row row-cols-1">
              <div className="col">
                <div className="testimonial-style-3 owl-nav-custom-1 position-relative text-white p-5 max-sm-p-30">
                  <span className="quote-icon bg-secondary position-absolute p-4"><i className="flaticon-text-quotes flat-80 text-primary" /></span>
                  <div className="row">
                    <div className="col-lg-8">
                      <div className="single-carousel owl-carousel owl-nav-icon-1 owl-dot-bottom-center owl-dot-round owl-dot-white owl-dot-active-pill-primary">
                        <div className="item">
                          <div className="entry-wrapper d-flex flex-column align-items-center text-start p-0">
                            <div className="entry-content-wrapper">
                              <div className="entry-header">
                                <h5 className="entry-title text-white mb-0">Dorothy R. Molina</h5>
                                <div className="text-primary mb-4"><span className="rank">Industrial engineer</span></div>
                              </div>
                              <div className="entry-content">
                                <div className="w-100 separate-line mb-4" />
                                <p>Elit aptent magna commodo lobortis et quisque nibh ligula vestibulum odio sagittis. Aliquet mauris, nisl tellus ornare nostra curae; volutpat massa, primis dignissim etiam dapibus quis atibus ut
                                  volutpat aptent fermentum per nascetur odio elit pede lorem velit praesent duis eros nisl enaeos Sed taciti justo ac lorem ultricies quisque magnis nullam massa netus vivamus. Parturient nunc
                                  imperdiet mauris elementum.
                                </p>
                              </div>
                            </div>
                          </div>
        ...
        {/*============================== Testimonial 4 Section Start ==============================*/}
        <div className="full-row bg-info">
          <div className="container">
            <div className="row">
              <div className="col-lg-6">
                <div className="row justify-content-start">
                  <div className="col-lg-6">
                    <span className="tagline text-white text-start mb-10">Testimonials</span>
                    <h1 className="text-white text-start mb-0">Featured Client Success Story</h1>
                  </div>
                </div>
                <div className="row">
                  <div className="col">
                    <div className="testimonial-style-4 owl-dot-custom-1 position-relative text-white mt-5">
                      <div className="single-carousel owl-carousel owl-nav-disable owl-nav-icon-1 owl-dot-bottom-start owl-dot-round owl-dot-white owl-dot-active-round-white">
                        <div className="item">
                          <div className="entry-wrapper d-flex flex-column align-items-center text-start p-0">
                            <div className="entry-content-wrapper">
                              <div className="entry-header">
                                <h5 className="entry-title text-white mb-0">Dorothy R. Molina</h5>
                                <div className="text-white mb-4"><span className="rank">Industrial engineer</span></div>
                              </div>
                              <div className="entry-content">
                                <div className="quotation">
                                  <i className="flaticon-text-quotes flat-45 text-white" />
                                </div>
                                <p>Elit aptent magna commodo lobortis et quisque nibh ligula vestibulum odio sagittis. Aliquet mauris, nisl tellus ornare nostra curae; volutpat massa, primis dignissim etiam dapibus quis atibus ut
                                  volutpat aptent fermentum per nascetur odio elit pede lorem velit praesent duis eros nisl enaeos Sed taciti justo ac lorem ultricies quisque magnis nullam massa netus vivamus. Parturient nunc
                                  imperdiet mauris elementum.
              ...
              <div className="col-lg-6">
                <img src="/assets/images/clipart/1.png" alt="Image Not Found !" />
              </div>
            </div>
          </div>
        </div>
        {/*============================== Testimonial 4 Section End ==============================*/}
        {/*============================== Testimonial 5 Section Start ==============================*/}
        <div className="full-row bg-secondary">
          <div className="container">
            <div className="row justify-content-start">
              <div className="col-lg-9">
                <span className="tagline text-general text-start text-uppercase mb-10">Latest Projects</span>
                <h1 className="text-white text-start mb-0">See Our <span className="fw-700 text-primary">Successful Businesses</span></h1>
              </div>
            </div>
            <div className="row row-cols-1 mt-5">
              <div className="col">
                <div className="owl-mx-4">
                  <div className="testimonial-style-5 owl-nav-custom-1 position-relative text-white">
