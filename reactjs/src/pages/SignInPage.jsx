              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Sign In</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Sign In</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
                ...
                <div className="shadow-sm p-5">
                  ...
                  <form action="#" method="post">
                    <div className="row row-cols-1 g-4">
                      <div className="col">
                        <input className="form-control bg-light" name="email" placeholder="E-mail" type="text" />
                      </div>
                      <div className="col">
                        <input className="form-control bg-light" name="password" placeholder="Password" type="password" />
                      </div>
                      <div className="col">
                        <input className="btn btn-secondary-filter rounded-0" defaultValue="Sign in" type="submit" />
                      </div>
                      <div className="col">
                        <span>Forger your password? <a className="color-default ms-2" href="#">Click Here</a></span>
                      </div>
                    </div>
                  </form>
                </div>
              ...
              <div className="col">
                <div className="shadow-sm p-5">
                  ...
                  <form action="#" method="post">
                    <div className="row row-cols-1 g-4">
                      <div className="col">
                        <input className="form-control bg-light" name="name" placeholder="Name" type="text" />
                      </div>
                      <div className="col">
                        <input className="form-control bg-light" name="email" placeholder="E-mail" type="text" />
                      </div>
                      ...
                      <div className="col">
                        <input id="checkbox1" className="d-none" name="checkbox1" type="checkbox" />
                        <label htmlFor="checkbox1" className="custom-checkbox-1">I agree with the terms and condition</label>
                      </div>
                      <div className="col">
                        <input className="btn btn-secondary-filter rounded-0" defaultValue="Register" type="submit" />
                      </div>
                    </div>
                  </form>
                </div>
