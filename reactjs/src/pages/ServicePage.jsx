              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Service</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Service</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row row-cols-xl-3 row-cols-md-2 row-cols-1 g-4">
              <div className="col">
                <div className="entry-wrapper d-flex flex-row align-items-start text-start bg-gray hover-text-white hover-bg-primary p-4 transition-all">
                  ...
                  <div className="entry-content-wrapper">
                    <div className="entry-header">
                      <h5 className="entry-title mb-2"><a className="text-secondary" href="/service-details.html">Home Security</a></h5>
                    </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-row align-items-start text-start bg-gray hover-text-white hover-bg-primary p-4 transition-all">
                  ...
                  <div className="entry-content-wrapper">
                    <div className="entry-header">
                      <h5 className="entry-title mb-2"><a className="text-secondary" href="/service-details.html">Cloud Security</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Habitant dictum metus rhoncus vitae ac ad litora etiam. Ante elementum vivamus integer tent.</p>
                    </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-row align-items-start text-start bg-gray hover-text-white hover-bg-primary p-4 transition-all">
                  ...
                  <div className="entry-content-wrapper">
                    <div className="entry-header">
                      <h5 className="entry-title mb-2"><a className="text-secondary" href="/service-details.html">Office Security</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Habitant dictum metus rhoncus vitae ac ad litora etiam. Ante elementum vivamus integer tent.</p>
                    </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-row align-items-start text-start bg-gray hover-text-white hover-bg-primary p-4 transition-all">
                  ...
                  <div className="entry-content-wrapper">
                    <div className="entry-header">
                      <h5 className="entry-title mb-2"><a className="text-secondary" href="/service-details.html">Computer Security</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Habitant dictum metus rhoncus vitae ac ad litora etiam. Ante elementum vivamus integer tent.</p>
                    </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-row align-items-start text-start bg-gray hover-text-white hover-bg-primary p-4 transition-all">
                  ...
                  <div className="entry-content-wrapper">
                    <div className="entry-header">
                      <h5 className="entry-title mb-2"><a className="text-secondary" href="/service-details.html">Body Guard</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Habitant dictum metus rhoncus vitae ac ad litora etiam. Ante elementum vivamus integer tent.</p>
                    </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-row align-items-start text-start bg-gray hover-text-white hover-bg-primary p-4 transition-all">
                  ...
                  <div className="entry-content-wrapper">
                    <div className="entry-header">
                      <h5 className="entry-title mb-2"><a className="text-secondary" href="/service-details.html">Biometric</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Habitant dictum metus rhoncus vitae ac ad litora etiam. Ante elementum vivamus integer tent.</p>
                    </div>
            ...
            <div className="row gy-5">
              ...
              <div className="col-lg-6">
                <div className="bar-progress progress-hight-3">
                  <div className="position-relative fact-counter text-secondary mb-5">
