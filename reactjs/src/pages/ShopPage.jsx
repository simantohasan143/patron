              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Shop</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Shop</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
                    ...
                    <div className="products-header d-flex justify-content-between align-items-center py-10 px-20 bg-light mb-30">
                      ...
                      <div className="products-header-right">
                        ...
                        <div className="products-view">
                          <a className="grid-view active" href="/shop.html"><i className="flaticon-menu-1 flat-15" /></a>
                          <a className="list-view" href="/shop-list.html"><i className="flaticon-list flat-15" /></a>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="row row-cols-lg-3 row-cols-sm-2 row-cols-1 g-4 product-style-3 e-img-bg-light transition-all">
                  <div className="col">
