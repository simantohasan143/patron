                ...
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  ...
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">FAQ</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
              ...
              <div className="col-md-8">
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <h2 className="down-line-primary text-secondary text-start mb-30">Freequenly Ask Question</h2>
                    <span className="sub-title fs-15 ordinary-font fst-normal text-general text-start mb-20">Accumsan lacinia. Venenatis pulvinar nostra ac vehicula posuere tortor molestie. Nam augue elementum Vivamus elit primis aliquam Nam lacinia pellentesque mus torquent mus ullamcorper placerat nullam velit ullamcorper curae justo suspendisse convallis leo proin interdum. Sodales vehicula vel sociis porttitor nonummy dis adipiscing.</span>
                  </div>
                </div>
                    ...
                    <div className="inline-form-style-1 product-search-number">
                      <form className="form-inline square-shape" action="#" method="post">
                        <div className="input-group">
                          <input type="text" className="form-control input-field bg-light" name="search" placeholder="Search Here Your Question..." />
                          <button type="submit" name="submit" className="submit text-general bg-light"><i className="fas fa-search" /></button>
                        </div>
                      </form>
                    </div>
                  </div>
                ...
                <div className="row accordion right-plus border-style-none mt-5">
                  <div className="col">
                    <div id="accordion-1">
                      ...
                      <div className="accordion-item bg-light">
                        <h2 className="accordion-header">
                          <button className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-5">What is the terms and condition to get a guard?</button>
                        </h2>
                        <div id="collapse-5" className="accordion-collapse collapse" data-bs-parent="#accordion-1">
                          <div className="accordion-body bg-white">
                            <p>Cubilia suspendisse, sodales Eu odio. Ad sollicitudin Mollis euismod natoque dis arcu vel fusce mattis metus taciti pellentesque netus malesuada. Vulputate nisi taciti netus leo lobortis est at leo. Tellus
                              semper amet cum condimentum lobortis pellentesque suscipit.</p>
                          </div>
                      ...
                      <div className="accordion-item bg-light">
                        <h2 className="accordion-header">
                          <button className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-6">Qualification and experience of the bodyguards?</button>
                        </h2>
                        <div id="collapse-6" className="accordion-collapse collapse" data-bs-parent="#accordion-1">
                          <div className="accordion-body bg-white">
                            <p>Cubilia suspendisse, sodales Eu odio. Ad sollicitudin Mollis euismod natoque dis arcu vel fusce mattis metus taciti pellentesque netus malesuada. Vulputate nisi taciti netus leo lobortis est at leo. Tellus
                              semper amet cum condimentum lobortis pellentesque suscipit.</p>
                          </div>
