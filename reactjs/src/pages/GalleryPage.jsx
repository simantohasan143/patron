    ...
    <>
      <div id="page-wrapper">
                ...
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  ...
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Gallery</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row row-cols-md-3 row-cols-1 g-4 gallery-style-1 transition-all">
              <div className="col">
