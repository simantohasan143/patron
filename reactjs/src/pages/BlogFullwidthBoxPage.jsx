export default function BlogFullwidthBoxPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">News Full</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">News Full</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row row-cols-lg-3 row-cols-md-2 row-cols-1 g-4 blog-style-1 entry-meta-divider-line transition-all">
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/11.png" alt="Image not found !" /></a>
                  ...
                  <div className="entry-content-wrapper pt-3">
                    <div className="entry-header">
                      ...
                      <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">Security system Of any building</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Molestie tincidunt enim. Cras odio cubilia sociis at consequat metus conubia lectus porta commodo malesuada ante conubia.</p>
                    </div>
                  </div>
                </article>
              </div>
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/17.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
                  ...
                  <div className="entry-content-wrapper pt-3">
                    <div className="entry-header">
                      ...
                      <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">Don't worry your data is safe</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Molestie tincidunt enim. Cras odio cubilia sociis at consequat metus conubia lectus porta commodo malesuada ante conubia.</p>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/18.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
                  ...
                  <div className="entry-content-wrapper pt-3">
                    <div className="entry-header">
                      ...
                      <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">How to develop your home security</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Molestie tincidunt enim. Cras odio cubilia sociis at consequat metus conubia lectus porta commodo malesuada ante conubia.</p>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/19.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
                  ...
                  <div className="entry-content-wrapper pt-3">
                    <div className="entry-header">
                      ...
                      <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">CCTV camera security control box</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Molestie tincidunt enim. Cras odio cubilia sociis at consequat metus conubia lectus porta commodo malesuada ante conubia.</p>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/20.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
                  ...
                  <div className="entry-content-wrapper pt-3">
                    <div className="entry-header">
                      ...
                      <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">Our best pc security system</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Molestie tincidunt enim. Cras odio cubilia sociis at consequat metus conubia lectus porta commodo malesuada ante conubia.</p>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/21.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
                  ...
                  <div className="entry-content-wrapper pt-3">
                    <div className="entry-header">
                      ...
                      <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">Configure your security cam</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Molestie tincidunt enim. Cras odio cubilia sociis at consequat metus conubia lectus porta commodo malesuada ante conubia.</p>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/22.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
                  ...
                  <div className="entry-content-wrapper pt-3">
                    <div className="entry-header">
                      ...
                      <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">Bodyguard duties &amp; activities</a></h5>
                    </div>
                    <div className="entry-content">
                      <p>Molestie tincidunt enim. Cras odio cubilia sociis at consequat metus conubia lectus porta commodo malesuada ante conubia.</p>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/23.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/24.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/12.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
              ...
              <div className="col">
                <article className="entry-wrapper">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-secondary">
                      <a href="#"><img src="/assets/images/thumb/10.png" alt="Image not found !" /></a>
                      <div className="position-absolute xy-center overflow-hidden">
                        <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                      </div>
                    </div>
