export default function GalleryFullwidthPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Full Gallery</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span className="text-secondary">Pages</span></li>
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Full Gallery</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row px-lg-5">
          <div className="container-fluid">
            <div className="row row-cols-xxl-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4 gallery-style-1 transition-all">
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/16.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/16.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/17.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/17.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/18.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/18.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/19.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/19.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/20.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/20.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/21.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/21.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/22.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/22.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/23.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/23.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/24.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/24.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/1.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/1.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/2.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/2.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden overlay-primary">
                      <img src="/assets/images/thumb/3.png" alt="Image not found !" />
                      <div className="position-absolute xy-center">
                        <div className="overflow-hidden text-center"><a href="/assets/images/thumb/3.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                        <div className="text-white text-center overflow-hidden"><a href="/gallery-detail.html" className="second-push-up transation text-white">Interiror design work</a></div>
                      </div>
                    </div>
                  </div>
