          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <span className="tagline text-primary text-center mb-10">Pricing Table</span>
                <h2 className="down-line-primary text-secondary text-center mb-30">Security Pakages</h2>
        ...
        <div className="full-row p-0">
          <div className="container">
            <div className="row row-cols-lg-2 row-cols-1 g-0">
              <div className="col">
                <div className="w-100 h-100" style={{backgroundImage: 'url(/assets/images/thumb/width-6.png)', backgroundSize: 'cover', backgroundPosition: 'center center'}} />
              </div>
              <div className="col">
                <div className="bg-dark h-100 sm-p-30" style={{padding: 100}}>
                  <h2 className="text-white mb-3">Start Home Security Pack Today</h2>
                  <div className="text-general fs-21 mb-5">Starting at <span className="text-primary h3">$99.99</span>/ month</div>
                  <a href="#" className="btn btn-primary btn-large rounded-0">Request Free Quote</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8">
                <span className="tagline text-primary text-center mb-10">Comparison</span>
                <h2 className="down-line-primary text-secondary text-center mb-30">Compare Pakages Oppertunity</h2>
                <span className="sub-title fs-18 ordinary-font fst-italic text-center mb-50">Aliquam litora ad sociosqu turpis etiam tempus egestas nulla diam tempus mollis ante ornare consectetuer dictum sodales adipiscing ultricies Elit semper Integer felis lectus.</span>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <div className="compare-chart-classic">
                  <div className="owl-carousel single-carousel owl-nav-disable autoplay-on owl-dot-bottom-center owl-dot-round owl-dot-active-pill-primary">
                    <div className="item">
                      <div className="item">
                        <table className="table mark-table-col-3 text-general mt-5">
                          <thead>
                            <tr>
                              <th><b className="fs-18">Private Security Pakage</b></th>
                              <th>Basic Security<br /><span className="h4 text-primary pt-1 pb-3 d-inline-block">$399.00</span><br />Every Week</th>
                              <th>
                                Medium Security<br /><span className="h4 text-primary pt-1 pb-3 d-inline-block">$799.00</span><br />Every Week
                                <div className="position-absolute w-100 text-center left-0 bg-primary" style={{top: '-40px', lineHeight: 38}}>Popular</div>
                              </th>
                              <th>Hight Security<br /><span className="h4 text-primary pt-1 pb-3 d-inline-block">$1,799.00</span><br />Every Day</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td>Number of Guard</td>
                              <td>1</td>
                              <td>3</td>
                              <td>10</td>
                            </tr>
                            <tr>
                              <td>Emeargency Shooting Power</td>
                            ...
                            <tr>
                              ...
                              <td><i className="far fa-window-close" /></td>
                              <td><i className="fas fa-check" /></td>
                              <td><i className="fas fa-check" /></td>
                            </tr>
                            <tr>
