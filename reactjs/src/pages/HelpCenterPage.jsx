      ...
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Support</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Support</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row bg-gray">
          <div className="container">
            <div className="row">
              <div className="col-lg-12">
                <h1 className="text-center mx-auto down-line-primary mb-5">How may we help you</h1>
              </div>
            </div>
            <div className="row">
              <div className="col-lg-12">
                <form action="#" method="post">
                  <div className="row justify-content-center gy-3">
                    <div className="col-lg-6 col-md-5">
                      <input type="text" className="form-control rounded-0" name="search" placeholder="Search Here..." />
                    </div>
                    <div className="col-lg-3 col-md-4">
                      <button className="btn btn-primary w-100 rounded-0">Get Help Now</button>
                    </div>
                  </div>
                </form>
              </div>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 entry-wrapper-bg-light hover-entry-wrapper-bg-primary g-4">
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center hover-text-white p-50 h-100 transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden">
                      <i className="icon flaticon-work flat-45 text-secondary" />
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary" href="#">Service Information</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center hover-text-white p-50 h-100 transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden">
                      <i className="icon flaticon-support flat-45 text-secondary" />
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary" href="#">General Support</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center hover-text-white p-50 h-100 transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden">
                      <i className="icon flaticon-settings flat-45 text-secondary" />
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary" href="#">Technical Support</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center hover-text-white p-50 h-100 transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden">
                      <i className="icon flaticon-survey flat-45 text-secondary" />
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary" href="#">Complain &amp; Objection</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center hover-text-white p-50 h-100 transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden">
                      <i className="icon flaticon-id-card flat-45 text-secondary" />
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary" href="#">Payment Guarantee</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center hover-text-white p-50 h-100 transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden">
                      <i className="icon flaticon-user-1 flat-45 text-secondary" />
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary" href="#">Account Support</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center hover-text-white p-50 h-100 transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden">
                      <i className="icon flaticon-shopping-1 flat-45 text-secondary" />
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary" href="#">Purchase Support</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center text-center hover-text-white p-50 h-100 transition-all">
                  <div className="entry-thumbnail-wrapper">
                    <div className="post-thumbnail overflow-hidden">
                      <i className="icon flaticon-touch flat-45 text-secondary" />
                    </div>
                  </div>
                  <div className="entry-content-wrapper pt-20">
                    <div className="entry-header">
                      <h5 className="entry-title mb-0"><a className="text-secondary" href="#">Now Getting Started</a></h5>
                    </div>
                  </div>
                </div>
              </div>
