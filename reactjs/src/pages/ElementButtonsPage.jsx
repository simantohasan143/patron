export default function ElementButtonsPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Buttons</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Buttons</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div className="row row-cols-lg-2 row-cols-1">
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Primary Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-primary rounded-0">Button</a>
                  </div>
                  <div className="col">
              ...
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Primary Filter Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-primary-filter rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-primary-filter">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-primary-filter rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Secondary Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-secondary rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-secondary">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-secondary rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Secondary Filter Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-secondary-filter rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-secondary-filter">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-secondary-filter rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Dark Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-dark rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-dark">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-dark rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Dark Filter Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-dark-filter rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-dark-filter">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-dark-filter rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Light Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 bg-primary p-30 mb-4 mt-3 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-light rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-light">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-light rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Light Filter Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 bg-primary p-30 mb-4 mt-3 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-light-filter rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-light-filter">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-light-filter rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">White Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 bg-primary p-30 mb-4 mt-3 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-white rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-white">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-white rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">White Filter Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 bg-primary p-30 mb-4 mt-3 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-white-filter rounded-0">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-white-filter">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-white-filter rounded-pill">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Shadow Move Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4 g-4">
                  <div className="col">
                    <a href="#" className="btn btn-primary-filter hover-shadow-move-1">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-secondary-filter hover-shadow-move-1">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-dark-filter hover-shadow-move-1">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="text-white btn bg-primary hover-shutter-out-horizontal hover-bg-secondary rounded-0 border-0">Work With Us</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Overlay Buttons</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4 gy-4">
                  <div className="col">
                    <a href="#" className="btn btn-primary-filter rounded-pill bg-secondary hover-bg-primary bg-full-from-right-1">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-secondary-filter rounded-pill bg-primary hover-bg-secondary bg-full-from-left-1">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="text-white rounded-pill bg-secondary hover-bg-primary bg-full-from-right-1 text-center py-10">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="text-white rounded-pill bg-primary hover-bg-secondary bg-full-from-left-1 text-center py-10">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-primary-filter rounded-pill bg-secondary hover-bg-primary bg-full-from-right-2">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn btn-secondary-filter rounded-pill bg-primary hover-bg-secondary bg-full-from-left-2">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="text-white rounded-pill bg-secondary hover-bg-primary bg-full-from-right-2 text-center py-10">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="text-white rounded-pill bg-primary hover-bg-secondary bg-full-from-left-2 text-center py-10">Button</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="row mb-3">
                  <div className="col">
                    <h3 className="mb-0">Link Button</h3>
                  </div>
                </div>
                <div className="row row-cols-sm-3 row-cols-1 mb-4 g-4">
                  <div className="col">
                    <a href="#" className="btn-link btn-hover-downline-1">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn-link btn-hover-downline-1 text-secondary">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn-link btn-hover-downline-1 text-dark">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn-link btn-hover-downline-2">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn-link btn-hover-downline-2 text-secondary">Button</a>
                  </div>
                  <div className="col">
                    <a href="#" className="btn-link btn-hover-downline-2 text-dark hover-text-primary">Button</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <footer className="full-row bg-footer text-light">
          <div className="container">
            <div className="row row-cols-sm-3 row-cols-1 row-cols-1 gy-5 xxs-link-single">
              <div className="col">
