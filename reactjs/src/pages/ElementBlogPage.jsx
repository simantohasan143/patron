export default function ElementBlogPage() {
  return (
    <>
      <div id="page-wrapper">
                ...
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  ...
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Blog</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        {/*============================== Blog Thumbnails Styles Start ==============================*/}
        <div className="full-row bg-light">
          <div className="container">
            <div className="row row-cols-lg-3 row-cols-md-2 row-cols-1 gy-5">
              <div className="col">
                <div className="blog-style- entry-meta-divider-line transition-all">
                  <article className="entry-wrapper">
                    ...
                    <div className="entry-content-wrapper pt-3">
                      <div className="entry-header">
                        <div className="entry-category"><span className="cat-links"><a href="#">Fashion Design</a></span></div>
                        <div className="entry-meta text-uppercase fs-11">
                          ...
                          <span className="posted-comment"><a href="#" className="text-general">23 Comments</a></span>
                        </div>
                        <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">Blog Post final Sample</a></h5>
                      </div>
                      <div className="entry-content">
                        <p>Nostra maecenas malesuada vel lobortis sociis mus aliquam tempor etiam ipsum pretium cursus nullam tortor.</p>
                      </div>
                      <div className="entry-footer">
                        <a href="#" className="text-general hover-text-primary">Read More <i className="fas fa-long-arrow-alt-right" /></a>
                      </div>
                    </div>
                  </article>
                </div>
              ...
              <div className="col">
                <div className="blog-style-1 entry-meta-divider-line transition-all">
                  <article className="entry-wrapper">
                    <div className="entry-thumbnail-wrapper">
                      <div className="post-thumbnail overflow-hidden overlay-secondary">
                        <a href="#"><img src="/assets/images/thumb/width-12.png" alt="Image not found !" /></a>
              ...
              <div className="col">
                <div className="blog-style-2 entry-meta-divider-line entry-wrapper-bg-light transition-all">
                  <article className="entry-wrapper">
                    ...
                    <div className="entry-content-wrapper p-3">
                      <div className="entry-header">
                        <div className="entry-meta text-uppercase fs-11 mb-3">
                          <span className="author-link"><a className="text-general hover-text-primary" href="#" title="Posts by Martin" rel="author">Martin</a></span>
                          <span className="posted-date"><a href="#" className="text-white">April 18, 2019</a></span>
                          <span className="posted-comment"><a className="text-general hover-text-primary" href="#">23 Comments</a></span>
                        </div>
                        <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">Time is money but its not full demand.</a></h5>
                      </div>
                      <div className="entry-footer">
                        <a href="#" className="btn btn-primary-filter"><i className="fas fa-chevron-right" /></a>
                      </div>
                    </div>
                  </article>
                </div>
              ...
              <div className="col">
                <div className="blog-style-3 bg-light transition-all">
                  <article className="entry-wrapper">
                    <div className="entry-thumbnail-wrapper">
                      <div className="post-thumbnail overflow-hidden hover-img-zoom">
                        <a href="#"><img src="/assets/images/thumb/height-1.png" alt="Image not found !" /></a>
                      </div>
                    ...
                    <div className="entry-content-wrapper p-3">
                      <div className="entry-header">
                        ...
                        <h5 className="entry-title mb-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-white">Time is money but its not full demand.</a></h5>
                      </div>
                      <div className="entry-footer">
                        <a href="#" className="btn btn-primary-filter"><i className="fas fa-chevron-right" /></a>
                      </div>
              ...
              <div className="col">
                <div className="blog-style-4 entry-wrapper-bg-white transition-all hover-child-effect">
                  <article className="entry-wrapper">
                    <div className="entry-thumbnail-wrapper position-relative">
                      <div className="post-thumbnail overflow-hidden overlay-secondary hover-img-zoom">
                        <a href="#"><img src="/assets/images/thumb/width-12.png" alt="Image not found !" /></a>
                        <div className="position-absolute xy-center overflow-hidden z-inded-9">
                          <a className="text-white first-push-up font-large" href="/news-details-left-sidebar.html">+</a>
                        </div>
                      </div>
                    </div>
                    <div className="post-content p-4">
                      <div className="entry-header">
                        <div className="entry-meta">
                          <span className="author-link"><a href="#" className="text-general hover-text-primary" title="Posts by Martin">Martin</a></span>
                          <span className="posted-date"><a href="#" className="text-white">18 <br /> September</a></span>
                          <span className="posted-comment"><a href="#" className="text-general hover-text-primary">23 Comments</a></span>
                        </div>
                        <h5 className="entry-title my-3 ordinary-font fw-500"><a href="/news-details-left-sidebar.html" className="text-dark hover-text-primary">Basic rule of running web agency business</a></h5>
                      </div>
                      <div className="entry-content mb-20">
                        <p>Lorem ipsum is simply is text used by copytyping refreshing.</p>
                      </div>
                      <div className="entry-footer d-flex align-items-center justify-content-between">
                        <a href="#" className="text-general hover-text-primary">Read More</a>
                        <a href="#" className="text-general hover-text-primary"><i className="fas fa-long-arrow-alt-right" /></a>
                      </div>
                    </div>
                  </article>
                </div>
                ...
                <article className="entry-wrapper hover-text-white">
                  ...
                  <div className="entry-content-wrapper p-5">
                    <div className="entry-header">
                      ...
                      <div className="entry-meta text-uppercase fs-11">
                        <span className="posted-date"><a href="#" className="text-light">Dec 25, 2019</a></span>
                      </div>
