export default function ElementPhotoGalleryPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Photo Gallery</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Photo Gallery</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-md-8">
                ...
                <h1 className="down-line text-white text-center mb-30">Photo Gallery</h1>
            ...
            <div className="row gallery-style-1 owl-mx-4">
              <div className="col-lg-12">
                <div className="owl-carousel 3block-carousel owl-dot-disable auto-play-on owl-nav-middle-outside owl-nav-icon-square owl-nav-icon-1 owl-nav-size-1 owl-nav-color-1">
                  <div className="item">
                    <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                      <div className="entry-thumbnail-wrapper">
                        <div className="post-thumbnail overflow-hidden overlay-primary">
                          <img src="/assets/images/thumb/height-1.png" alt="Image not found !" />
                          <div className="position-absolute xy-center">
                            <div className="overflow-hidden"><a href="/assets/images/thumb/height-1.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="item">
                    <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                      <div className="entry-thumbnail-wrapper">
                        <div className="post-thumbnail overflow-hidden overlay-primary">
                          <img src="/assets/images/thumb/height-5.png" alt="Image not found !" />
                          <div className="position-absolute xy-center">
                            <div className="overflow-hidden"><a href="/assets/images/thumb/height-5.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="item">
                    <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                      <div className="entry-thumbnail-wrapper">
                        <div className="post-thumbnail overflow-hidden overlay-primary">
                          <img src="/assets/images/thumb/height-6.png" alt="Image not found !" />
                          <div className="position-absolute xy-center">
                            <div className="overflow-hidden"><a href="/assets/images/thumb/height-6.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="entry-wrapper d-flex flex-column align-items-center transition-all">
                      <div className="entry-thumbnail-wrapper">
                        <div className="post-thumbnail overflow-hidden overlay-primary">
                          ...
                          <div className="position-absolute xy-center">
                            <div className="overflow-hidden"><a href="/assets/images/thumb/height-7.png" className="first-push-up" data-fancybox="images" data-caption="Caption for single image"><span className="flaticon-zoom-in flat-30 text-white" /></a></div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-md-7">
                <span className="tagline text-primary text-center mb-10">See Our Experience</span>
                <h2 className="down-line text-secondary text-center mb-30">Photo Gallery</h2>
                <span className="sub-title fs-15 highlight-font fst-normal text-general text-center mb-50">Mauris primis turpis Laoreet magna felis mi amet quam enim curae. Sodales semper tempor dictum faucibus habitasse.</span>
              </div>
            </div>
        ...
        <div className="full-row bg-white pt-0">
          <div className="container">
            <div className="row row-cols-md-3 row-cols-1 g-0 gallery-style-2 hover-img-grayscale-0 transition-all">
              <div className="col">
                <div className="entry-wrapper d-flex flex-column align-items-center position-relative text-start">
                  ...
                  <div className="entry-content-wrapper">
                    ...
                    <div className="entry-content">
                      <a href="/assets/images/thumb/height-9.png" data-fancybox data-caption="Caption for single image"><i className="far fa-plus-square" /></a>
                    </div>
                  </div>
                </div>
              </div>
