export default function ElementPricingTablePage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Pricing Table</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Pricing Table</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div className="row row-cols-lg-3 row-cols-md-2 row-cols-1 g-4 pricing-style-1">
              <div className="col">
                <div className="pricing-wrapper py-40 text-center bg-gray">
                  ...
                  <div className="mt-30">
                    <a className="btn btn-primary-filter hover-shadow-move-1 rounded-0" href="#">Buy Now</a>
                  </div>
                </div>
              </div>
              <div className="col">
        ...
        <div className="full-row bg-light">
          <div className="container">
            <div className="row justify-content-start">
              <div className="col-lg-8">
                <span className="tagline text-primary text-start mb-1">Pricing Table</span>
                <h3 className="down-line text-secondary text-start mb-50">Security Pakages</h3>
              </div>
            </div>
            <div className="row row-cols-xl-4 row-cols-md-2 row-cols-1 g-2 pricing-style-2">
              <div className="col">
                <div className="pricing-wrapper bg-secondary hover-bg-primary text-white hover-text-white transition-all">
                  <div className="p-4">
                    <h5 className="text-white mb-3">Private Security</h5>
                    <span className="h4 text-primary d-inline-block">$399</span>
                    <span className="highlight-font fs-18 text-white d-block">Personal Security and Support</span>
                  </div>
                  <div className="price-data p-4">
                    <p>We provide single security guard and equipment</p>
                  </div>
                  <div className="p-4">
                    <a href="#" className="btn btn-primary-filter hover-shadow-move-1 rounded-0" style={{marginTop: '-70px'}}>Request Now</a>
                    <ul className="white-icon-list-2 list-lh-30 list-color-white">
                      <li>Euismod elit posuere.</li>
                      <li>Sociis elit feugiat.</li>
                      <li>Praesent ante Praesent.</li>
                      <li>Suscipit dictum tristique.</li>
                      <li>Interdum nullam aptent.</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="pricing-wrapper bg-secondary hover-bg-primary text-white hover-text-white transition-all">
                  <div className="p-4">
                    <h5 className="text-white mb-3">Housing Security</h5>
                    <span className="h4 text-primary d-inline-block">$1099</span>
                    <span className="highlight-font fs-18 text-white d-block">Technical Security Support</span>
                  </div>
                  <div className="price-data p-4">
                    <p>We provide single security guard and equipment</p>
                  </div>
                  <div className="p-4">
                    <a href="#" className="btn btn-primary-filter hover-shadow-move-1 rounded-0" style={{marginTop: '-70px'}}>Request Now</a>
                    <ul className="white-icon-list-2 list-lh-30 list-color-white">
                      <li>Tortor luctus non volutpat.</li>
                      <li>Bibendum vulputate.</li>
                      <li>Ultricies, in volutpat nunc.</li>
                      <li>Eleifend vulputate massa.</li>
                      <li>Eleifend ridiculus imperdiet.</li>
                      <li>Curae elit pharetra mattis.</li>
                      <li>Felis quis dictum vitae netus.</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="pricing-wrapper bg-secondary hover-bg-primary text-white hover-text-white transition-all">
                  <div className="p-4">
                    <h5 className="text-white mb-3">Installation</h5>
                    <span className="h4 text-primary d-inline-block">$850</span>
                    <span className="highlight-font fs-18 text-white d-block">Security system installation</span>
                  </div>
                  <div className="price-data p-4">
                    <p>supply business and building security system and support</p>
                  </div>
                  <div className="p-4">
                    <a href="#" className="btn btn-primary-filter hover-shadow-move-1 rounded-0" style={{marginTop: '-70px'}}>Request Now</a>
                    <ul className="white-icon-list-2 list-lh-30 list-color-white">
              ...
              <div className="col">
                <div className="pricing-wrapper bg-secondary hover-bg-primary text-white hover-text-white transition-all">
                  <div className="p-4">
                    <h5 className="text-white mb-3">Video Covarage</h5>
                    <span className="h4 text-primary d-inline-block">$2200</span>
                    <span className="highlight-font fs-18 text-white d-block">Event and area monitoring</span>
                  </div>
                  <div className="price-data p-4">
                    <p>Specific area coverage and monitoring for any event</p>
                  </div>
                  <div className="p-4">
                    <a href="#" className="btn btn-primary-filter hover-shadow-move-1 rounded-0" style={{marginTop: '-70px'}}>Request Now</a>
                    <ul className="white-icon-list-2 list-lh-30 list-color-white">
        ...
        <div className="full-row pt-0">
          <div className="container">
            <div className="row row-cols-lg-4 row-cols-sm-2 row-cols-1 g-0 pricing-style-3">
              <div className="col">
                <div className="pricing-wrapper text-white text-center gradient-bg-2 transition-all">
                  <h3 className="mb-2 text-white">Standart</h3>
                  <p>Best for starter sites</p>
                  <div className="image-wrap">
                    <img src="/assets/images/extra/1.png" alt="Image not found !" />
                  </div>
                  <ul className="list-lh-30">
                    <li>1 Website</li>
                  ...
                  <div className="price mt-40">
                    <span className="h2 fw-400 text-white d-block mb-0">5.99</span>
                    <span className="text-uppercase h6 fw-400 text-white">Us$/Mo</span>
                  </div>
                  <div className="mt-40">
                    <a className="btn btn-outline-white text-uppercase rounded-pill" href="#">Buy Now</a>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="pricing-wrapper text-white text-center gradient-bg-3 transition-all">
                  <span className="position-absolute x-center top-0 bg-white text-secondary px-10 rounded-bottom">Recommended</span>
                  <h3 className="mb-2 text-white">Deluxe</h3>
                  <p>Best for small company</p>
                  <div className="image-wrap">
                    <img src="/assets/images/extra/1.png" alt="Image not found !" />
                  </div>
                  <ul className="list-lh-30">
                    <li>Standart features, plus</li>
                    <li>10 Website</li>
                    <li>1TB storages</li>
                    <li>10 subdomains</li>
                  ...
                  <div className="price mt-40">
                    <span className="h2 fw-400 text-white d-block mb-0">6.99</span>
                    <span className="text-uppercase h6 fw-400 text-white">Us$/Mo</span>
                  </div>
                  <div className="mt-40">
                    <a className="btn btn-outline-white text-uppercase rounded-pill" href="#">Buy Now</a>
              ...
              <div className="col">
                <div className="pricing-wrapper text-white text-center gradient-bg-4 transition-all">
                  <h3 className="mb-2 text-white">Ultimate</h3>
                  <p>Best for complex sites</p>
                  <div className="image-wrap">
                    <img src="/assets/images/extra/1.png" alt="Image not found !" />
                  </div>
                  <ul className="list-lh-30">
                    <li>Deluxe features, plus</li>
                  ...
                  <div className="price mt-40">
                    <span className="h2 fw-400 text-white d-block mb-0">7.99</span>
                    <span className="text-uppercase h6 fw-400 text-white">Us$/Mo</span>
                  </div>
                  <div className="mt-40">
                    <a className="btn btn-outline-white text-uppercase rounded-pill" href="#">Buy Now</a>
              ...
              <div className="col">
                <div className="pricing-wrapper text-white text-center gradient-bg-5 transition-all">
                  <h3 className="mb-2 text-white">Advanced</h3>
                  <p>Optimzed for high traffic</p>
                  <div className="image-wrap">
                    <img src="/assets/images/extra/1.png" alt="Image not found !" />
                  </div>
                  <ul className="list-lh-30">
                    <li>Unlimited features, plus</li>
                    <li>Free SSL Certificate forever</li>
                    <li>VPS Super Power</li>
                    <li>Dedicated resources</li>
                    <li>Unlimited MySQL databases</li>
                  </ul>
                  <div className="price mt-40">
                    <span className="h2 fw-400 text-white d-block mb-0">8.99</span>
                    <span className="text-uppercase h6 fw-400 text-white">Us$/Mo</span>
                  </div>
                  <div className="mt-40">
                    <a className="btn btn-outline-white text-uppercase rounded-pill" href="#">Buy Now</a>
