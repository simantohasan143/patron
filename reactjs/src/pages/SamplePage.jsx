  ...
  return (
    <>
      <div>
        ...
        {/*============================== Header Section End ==============================*/}
        <div className="list-width-full icon-in-list list-icon-1 list-icon-top list-icon-primary list-text-white list-lh-30 list-py-5 mt-4">
          {/* 
            .list-width-full/.list-width-half/.list-width-three-fold
            .icon-in-list   =   icon in li
            .icon-in-hyperlink   =   icon in li>a
            .list-icon-1/.list-icon-2/.list-icon-3
            .list-icon-top/.list-icon-center
            .list-icon-primary/.list-icon-secondary/.list-icon-dark/.list-icon-white/.list-icon-extra1/.list-icon-extra2/.list-icon-extra3/.list-icon-extra4
            .list-text-primary/.list-text-secondary/.list-text-dark/.list-text-white/.list-text-extra1/.list-text-extra2/.list-text-extra-3/.list-text-extra4
            .list-lh-30/
            .list-py-5
            .mt-0/.mt-4/.mt-5/.mt-30
         */}
          <ul>
        ...
        <div className="single-carousel owl-carousel owl-nav-disable owl-dot-round owl-dot-bottom-center owl-dot-active-pill-primary auto-play-on">
          {/* 
            .testimonials
            .single-carousel/.3block-carousel/.4block-carousel
            .autoplay-on/.autoplay-off
            .owl-nav-disable
            .owl-nav-icon-none
            .owl-nav-text-none/.owl-nav-text-box/.owl-nav-text-capsoul
            .owl-nav-text-1/.owl-nav-text-2
            .owl-nav-top-left/.owl-nav-top-right-1/.owl-nav-top-right-2/.owl-nav-bottom-left/.owl-nav-bottom-right/.owl-nav-bottom-center
            .owl-nav-middle-inside/.owl-nav-middle-outside/.owl-nav-middle-outside-long
            .owl-nav-icon-square/.owl-nav-icon-radius/..owl-nav-icon-round/.owl-nav-icon-capsoul/.owl-nav-icon-normal
            .owl-nav-icon-1/.owl-nav-icon-2/.owl-nav-icon-3
            .owl-nav-size-1
            .owl-nav-color-1
            .owl-nav-custom-1
            .owl-dot-disable
            .owl-dot-round
            .dots-border-circle
            .owl-dot-bottom-center/.owl-dot-bottom-left/.owl-dot-bottom-right
            .owl-dot-active-1
            .owl-dot-white
            .owl-dot-size-1
        ...
        <div className="full-row">
          <div className="container">
            <div className="row row-cols-lg-3 img-grid-thumb-1">
              {/* img-grid-thumb-1 */}
              <div className="col">
                <div className="image-wrap position-relative overflow-hidden">
                  <img src="/assets/images/thumb/width-1.png" alt />
                </div>
                <h3 className="my-3"><a href="/experience.html" className="text-secondary transation hover-text-primary">Our Experience</a></h3>
                ...
                <a href="/experience.html" className="btn-link">Read More</a>
              </div>
            </div>
          </div>
        </div>
