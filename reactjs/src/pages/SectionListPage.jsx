  ...
  return (
    <>
      <div>
        ...
        <header id="header" className="default-header bg-default nav-initial nav-on-banner border-bottom">
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12">
                  <nav className="navbar navbar-expand-lg navbar-light bg-light nav-dark nav-primary-hover nav-primary-active">
                      ...
                      <ul className="navbar-nav justify-content-end">
                        <li className="nav-item dropdown">
                          ...
                          <ul className="dropdown-menu">
                            ...
                            <li><a className="dropdown-item" href="/index-security.html">Home-1</a></li>
                            <li><a className="dropdown-item" href="/index-security-2.html">Home-2</a></li>
                            <li><a className="dropdown-item" href="/index-security-3.html">Home-3</a></li>
                            <li><a className="dropdown-item" href="/index-security-4.html">Home-4</a></li>
                            <li><a className="dropdown-item" href="/index-security-5.html">Home-5</a></li>
                            <li><a className="dropdown-item" href="/index-security-6.html">Home-6</a></li>
                            <li><a className="dropdown-item" href="/index-security-7.html">Home-7</a></li>
                            <li><a className="dropdown-item" href="/index-security-8.html">Home-8</a></li>
                            <li><a className="dropdown-item" href="/index-security-9.html">Home-9</a></li>
                            <li><a className="dropdown-item" href="/index-security-10.html">Home-10</a></li>
                          </ul>
                        </li>
                        <li className="nav-item dropdown">
          ...
          <div className="header-sticky bg-secondary px-lg-5">
            <div className="container">
              <div className="row align-items-center">
                <div className="col">
                  <nav className="navbar navbar-expand-lg navbar-light nav-white nav-primary-hover nav-primary-active">
                    <a className="navbar-brand" href="#"><img className="nav-logo" src="/assets/images/logo/1.png" alt="Patron" /></a>
        ...
        <div className="full-row">
          <div className="container">
            <div className="row row-cols-lg-3">
              ...
              <div className="col">
                <div className="list-width-full icon-in-list list-icon-1 list-icon-center list-icon-secondary list-text-secondary list-py-10 mt-0">
                  {/* list-width-full/list-width-half/list-width-three-fold */}
                  {/* min-md/min-lg/min-xl/min-xxl */}
                  {/* icon-in-list/icon-in-hyperlink */}
                  {/* list-icon-1/list-icon-2/list-icon-3 */}
                  {/* list-icon-top/list-icon-center */}
                  {/* list-icon-primary/list-icon-secondary/list-icon-dark/list-icon-white/list-icon-success/list-icon-extra1/list-icon-extra2/list-icon-extra3/list-icon-extra4 */}
                  {/* list-text-primary/list-text-secondary/list-text-dark/list-text-white/list-text-success/list-text-extra1/list-text-extra2/list-text-extra3/list-text-extra4 */}
                  {/* list-py-5/list-py-10 */}
                  {/* mt-0/mt-20/mt-30/mt-40/mt-50 */}
                  <ul>
              ...
              <div className="col">
                <div className="list-width-full icon-in-list list-icon-2 list-icon-center list-icon-secondary list-text-secondary list-py-10 mt-0">
                  <ul>
                    <li>Master key systems</li>
                    <li>High security cylinders</li>
                    <li>Changing and rekeying locks</li>
              ...
              <div className="col">
                <div className="list-width-full icon-in-list list-icon-3 list-icon-center list-icon-secondary list-text-secondary list-py-10 mt-0">
                  <ul>
                    <li>Master key systems</li>
                    <li>High security cylinders</li>
                    <li>Changing and rekeying locks</li>
            ...
            <div className="row row-cols-lg-3">
              <div className="col-12">
                <h2 className="mt-5">Icon in Hyperlink</h2>
              </div>
              <div className="col">
                <div className="list-width-full icon-in-hyperlink list-icon-1 list-icon-center list-icon-secondary list-text-secondary list-py-10 mt-0">
                  <ul>
                    <li><a href="#">Master key systems</a></li>
                    <li><a href="#">High security cylinders</a></li>
                    <li><a href="#">Changing and rekeying locks</a></li>
                    <li><a href="#">Keyless entry systems</a></li>
                    <li><a href="#">Fast lock out service</a></li>
                    <li><a href="#">Installation and repair of locks</a></li>
                    <li><a href="#">Window locks</a></li>
                    <li><a href="#">Deadlocks &amp; Padlocks</a></li>
                  </ul>
                </div>
              </div>
              <div className="col">
                <div className="list-width-full icon-in-hyperlink list-icon-2 list-icon-center list-icon-secondary list-text-secondary list-py-10 mt-0">
                  <ul>
                    <li><a href="#">Master key systems</a></li>
                    <li><a href="#">High security cylinders</a></li>
                    <li><a href="#">Changing and rekeying locks</a></li>
              ...
              <div className="col">
                <div className="list-width-full icon-in-hyperlink list-icon-3 list-icon-center list-icon-secondary list-text-secondary list-py-10 mt-0">
                  <ul>
                    <li><a href="#">Master key systems</a></li>
                    <li><a href="#">High security cylinders</a></li>
                    <li><a href="#">Changing and rekeying locks</a></li>
            ...
            <div className="row row-cols-lg-2">
              <div className="col-12">
                <h2 className="mt-5">List in two columns</h2>
              </div>
              <div className="col">
                <div className="list-width-half min-lg icon-in-hyperlink list-icon-1 list-icon-center list-icon-secondary list-text-secondary list-py-10 mt-0">
                  <ul>
                    <li><a href="#">Master key systems</a></li>
                    <li><a href="#">High security cylinders</a></li>
                    <li><a href="#">Changing and rekeying locks</a></li>
              ...
              <div className="col-12">
                <h2 className="mt-5">List in three columns</h2>
              </div>
              <div className="col-8">
                <div className="list-width-three-fold min-xl icon-in-hyperlink list-icon-1 list-icon-center list-icon-secondary list-text-secondary list-py-10 mt-30">
                  <ul>
                    <li><a href="#">Master key systems</a></li>
                    <li><a href="#">High security cylinders</a></li>
                    <li><a href="#">Changing and rekeying locks</a></li>
