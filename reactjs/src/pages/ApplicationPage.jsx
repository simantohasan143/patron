              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Application</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Application</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
                ...
                <div className="inner-sidebar">
                  <div className="sidebar-nav widget">
                    <ul>
                      ...
                      <li className="active"><a href="/application.html">Application</a></li>
              ...
              <div className="col-md-8">
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <h3 className="down-line-primary text-secondary text-start mb-20">Job Description</h3>
                    <ul className="mb-2">
                      <li><b className="me-2">Job Title:</b> Executive Officer</li>
                      <li><b className="me-2">Vacancy:</b> 2 Person</li>
                    </ul>
                ...
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <h3 className="down-line-primary text-secondary text-start mb-20">Position Summary</h3>
                    <ul className="mb-2">
                      <li><b className="me-2">Location:</b> Head Office, San Franciso, USA</li>
                      <li><b className="me-2">Depeartment:</b> Security Supply</li>
                      <li><b className="me-2">Salary:</b> $4K - $5K</li>
                    </ul>
                    <span className="sub-title fs-15 ordinary-font fst-normal text-general text-start mb-30">Posuere ante tincidunt sed porta senectus fusce interdum. Dictum class semper Ornare venenatis habitant sodales. Venenatis volutpat torquent. Curae; suspendisse ligula suscipit magna. Interdum dapibus in nulla mollis velit taciti mollis gravida torquent lacus lobortis volutpat elementum leo pharetra.</span>
                  </div>
                </div>
                <div className="row mb-30">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    ...
                    <ul className="list-number">
                      <li>Integer lacinia mus sociosqu. Velit enim interdum dictumst. Sed leo inceptos egestas diam diam luctus.</li>
                      <li>Quam natoque duis hymenaeos torquent curabitur sit hymenaeos laoreet felis.</li>
                      <li>Curabitur vel amet aenean aliquet suscipit aenean fermentum, tincidunt purus interdum id.</li>
                      <li>A nonummy magnis nibh ridiculus enim viverra aenean.</li>
                      <li>Lacus id torquent amet vestibulum iaculis odio lacinia cubilia magna sociosqu cursus condimentum magnis phasellus wacus conubia eget viverra eros aliquam dictum.</li>
                      <li>Fringilla ornare elementum dis eget Hac libero mus ut ut facilisi porttitor leo nascetur dui lacinia diam egestas purus globortis ad eu </li>
                    </ul>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-12 wow animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                    <h3 className="down-line-primary text-secondary text-start mb-20">Application Here</h3>
                    <form action="#" method="post" noValidate="novalidate">
                      <div className="row g-4">
                        <div className="col-md-6">
                          <input className="form-control bg-light" id="first-name" name="first-name" placeholder="First Name*" type="text" />
                        </div>
                        <div className="col-md-6">
                          <input className="form-control bg-light" id="last-name" name="last-name" placeholder="First Last*" type="text" />
                        </div>
                        <div className="col-md-6">
                          <input className="form-control bg-light" id="email" name="email" placeholder="Email*" type="text" />
                        </div>
                        <div className="col-md-6">
                          <input className="form-control bg-light" id="address" name="address" placeholder="Address*" type="text" />
                        </div>
                        <div className="col-md-6">
                          <input className="form-control bg-light" id="city" name="city" placeholder="City*" type="text" />
                        </div>
                        <div className="col-md-6">
                          <input className="form-control bg-light" id="zip-code" name="zip-code" placeholder="Zip Code*" type="text" />
                        </div>
                        <div className="col-md-6">
                          <input className="form-control bg-light" id="country" name="country" placeholder="Country*" type="text" />
                        </div>
                        <div className="col-md-6">
                        ...
                        <div className="col-md-12">
                          <textarea className="form-control bg-light" rows={10} id="message" name="message" placeholder="Message" defaultValue={""} />
                        </div>
                        <div id="file" className="col-md-6">
                          <input className="attatchment" id="browse" name="fileupload" type="file" />
                        </div>
                        <div className="col-md-6">
                          <input className="btn btn-primary float-md-end py-2" id="send" defaultValue="send application" type="submit" />
                        </div>
                        <div className="col-md-12">
