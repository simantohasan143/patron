export default function PricingExtendPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Pricing Extend</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><a href="/pricing.html" className="text-secondary hover-text-primary">Pricing</a></li>
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Pricing Extend</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        {/*============================== Pricing Extend Section Start ==============================*/}
        <div className="full-row">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <span className="tagline text-primary text-center mb-10">Service</span>
                <h2 className="down-line-primary text-secondary text-center mb-30">Cost Customize</h2>
              </div>
            </div>
            <div className="row justify-content-center">
                ...
                <form method="post" action="#">
                  <div className="row g-4">
                    ...
                    <div className="col-md-6">
                      <div className="select-appearance-general bg-color">
                        <select className="form-control bg-light">
                          <option>Select Your Security Type</option>
                          <option>Security Type-1</option>
                          <option>Security Type-2</option>
                          <option>Security Type-3</option>
                        </select>
                      </div>
                    </div>
                    <div className="col-md-12">
                      <div className="service-measurement my-4">
                        <h2 className="mb-4">Increase or Decrease your Service</h2>
                        <div className="row g-4">
                          <div className="col-md-6">
                            <div className="single-select bg-light p-4 h-100">
                              <label>Change how many Security Guard you need.</label>
                              <div className="range-slider">
                                <input className="range-slider__range" type="range" defaultValue={25} min={0} max={100} />
                                <span className="range-slider__value">25</span> </div>
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="single-select bg-light p-4 h-100">
                              <label>Number of security camera</label>
                              <div className="range-slider">
                                <input className="range-slider__range" type="range" defaultValue={25} min={0} max={100} />
                                <span className="range-slider__value">25</span> </div>
                            </div>
                          ...
                          <div className="col-md-6">
                            <div className="single-select bg-light p-4 h-100">
                              <label>Number of security door.</label>
                              <div className="range-slider">
                                <input className="range-slider__range" type="range" defaultValue={25} min={0} max={100} />
                                <span className="range-slider__value">25</span> </div>
                            </div>
                          ...
                          <div className="col-md-6">
                            <div className="single-select bg-light p-4 h-100">
                              <label>Number of dog squad.</label>
                              <div className="range-slider">
                                <input className="range-slider__range" type="range" defaultValue={25} min={0} max={100} />
                                <span className="range-slider__value">25</span> </div>
                            </div>
                          ...
                          <div className="col-md-6">
                            <div className="single-select bg-light p-4 h-100">
                              <label>Coverage area for security square feet.</label>
                              <div className="range-slider">
                                <input className="range-slider__range" type="range" defaultValue={25} min={0} max={100} />
                                <span className="range-slider__value">25</span> </div>
                            </div>
                          ...
                          <div className="col-md-4">
                            <div className="single-select bg-light p-4 h-100">
                              <label className="mb-3">Select your apartment type</label>
                              <div className="select-appearance-general bg-color">
                                <select name="select-apartment" className="select-service form-control">
                                  <option value="your-city">Choose...</option>
                                  <option value="Newyork">type-1</option>
                                  <option value="California">type-2</option>
                                  <option value="Texas">type-3</option>
                                  <option value="Arizona">type-4</option>
                                  <option value="Washington">type-5</option>
                                </select>
                                {/* /.select-city */}
                              </div>
                            </div>
                          ...
                          <div className="col-md-4">
                            <div className="form-check form-switch bg-light p-4 pb-5 h-100">
                              <label className="form-check-label d-block mb-4" htmlFor="flexSwitchCheckDefault">Do you need emergency support?</label>
                              <input className="form-check-input" type="checkbox" id="flexSwitchCheckDefault" />
                            </div>
                          </div>
                          <div className="col-md-4">
                            <div className="form-check form-switch bg-light p-4 pb-5 h-100">
                              <label className="form-check-label d-block mb-4" htmlFor="flexSwitchCheckDefault2">Do you need IP?</label>
                      ...
                      <div className="additional-security">
                        <h2 className="mb-4">Select Additional Security Options</h2>
                        <div className="row g-4">
                          <div className="col-md-6">
                            <div className="bg-light p-4 h-100">
                              <label className="mb-2">Select your any other support.</label>
                              <div className="select-appearance-general bg-color">
                                <select name="select-apartment" className="select-service form-control">
                                  <option value="your-city">Select support option</option>
                                  <option value="Newyork">support-1</option>
                                  <option value="California">support-2</option>
                                  <option value="Texas">support-3</option>
                                  <option value="Arizona">support-4</option>
                                  <option value="Washington">support-5</option>
                                </select>
                              </div>
                              {/* /.select-city */}
                            </div>
                          ...
                          <div className="col-md-6">
                            <div className="bg-light p-4 h-100">
                              <label className="mb-2">Security robot or bulletproof tools.</label>
                              <div className="select-appearance-general bg-color">
                                <select name="select-apartment" className="select-service form-control">
                                  <option value="your-city">Choose tools type</option>
                                  <option value="Newyork">type-1</option>
                                  <option value="California">type-2</option>
                                  <option value="Texas">type-3</option>
                                  <option value="Arizona">type-4</option>
                          ...
                          <div className="col-md-12">
                            <div className="single-select bg-light p-4 h-100">
                              <label className="mb-4">Include other additional features for security</label>
                              <div className="additional-features d-inline-block">
                                <input className="d-none" type="checkbox" id="pepper-spray" name="pepper-spray" defaultValue="Pepper Spray" />
                                <label htmlFor="pepper-spray" className="bg-white text-center">Pepper Spray</label>
                                <input className="d-none" type="checkbox" id="handgun" name="handgun" defaultValue="Handgun" />
                                <label htmlFor="handgun" className="bg-white text-center">Handgun</label>
                                <input className="d-none" type="checkbox" id="sniper" name="sniper" defaultValue="Sniper" />
                                <label htmlFor="sniper" className="bg-white text-center">Sniper</label>
                                <input className="d-none" type="checkbox" id="body-scanners" name="body-scanners" defaultValue="Body Scanners" />
                                <label htmlFor="body-scanners" className="bg-white text-center">Body Scanners</label>
                                <input className="d-none" type="checkbox" id="fire-sefty" name="fire-sefty" defaultValue="Fire Sefty" />
                                <label htmlFor="fire-sefty" className="bg-white text-center">Fire Sefty</label>
                                <input className="d-none" type="checkbox" id="backup" name="backup" defaultValue="Backup" />
                                <label htmlFor="backup" className="bg-white text-center">Backup</label>
                                <input className="d-none" type="checkbox" id="ambulance" name="ambulance" defaultValue="Ambulance" />
                                <label htmlFor="ambulance" className="bg-white text-center">Ambulance</label>
                                <input className="d-none" type="checkbox" id="sefty-bag" name="sefty-bag" defaultValue="Sefty Bag" />
                                <label htmlFor="sefty-bag" className="bg-white text-center">Sefty Bag</label>
                              </div>
                            </div>
                          </div>
                          <div className="col-md-12">
                            <div className="total-cost">
                              <div className="row g-4">
                                <div className="col-md-8">
                                  <div>
                                    <p><strong>Note: </strong> Primis orci erat ante. Lorem iaculis odio nam. Tellus aliquam consectetuer velit. Nonummy curabitur nec pellentesque justo tellus netus tempus dolor penatibus urna
                                      cum. Elementum ad pulvinar.</p>
                                  </div>
                                </div>
                                <div className="col-md-4">
                                  <span className="float-md-end fs-21 px-4 py-3 bg-primary text-white">
