export default function ElementTeamPage() {
  return (
    <>
      <div id="page-wrapper">
                ...
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  ...
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Team</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8">
                ...
                <h2 className="down-line text-secondary text-center mb-30">Team Leaders</h2>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <span className="tagline text-uppercase text-primary text-center mb-10">Our Team</span>
                <h1 className="text-uppercase text-center mb-50">Expert Members.</h1>
              </div>
            </div>
                  ...
                  <div className="item">
                    <div className="entry-wrapper d-flex flex-column justify-content-center text-center transition-all">
                      <div className="entry-thumbnail-wrapper position-relative">
                        <div className="post-thumbnail hover-img-filter">
                          <img src="/assets/images/thumb/height-7.png" alt="Image not found !" />
        ...
        <div className="full-row pt-0">
          <div className="container">
            <div className="row row-cols-lg-4 g-4 team-style-3 entry-wrapper-bg-white">
              <div className="col">
