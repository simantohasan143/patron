  ...
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">How It Work</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">How It Work</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        {/*============================== How get service section start ==============================*/}
        <div className="full-row">
          <div className="container">
            <div className="row">
              <div className="col-lg-7">
                <h2 className="down-line-primary mb-4">How can I get the service from world wide?</h2>
                <p>Tristique nam platea. Hendrerit iaculis turpis pharetra egestas sem orci. Tristique eget parturient lobortis. Maecenas lacinia iaculis sed netus vivamus gravida ad pretium tempor dolor tristique. Accumsan at vitae dictum eget convallis
                  ut nulla ridiculus purus sollicitudin velit torquent penatibus mauris.</p>
                <p>Sodales gravida fermentum phasellus nonummy vulputate nec fermentum platea convallis potenti phasellus torquent lorem duis per sodales in scelerisque facilisi, at faucibus blandit suspendisse lacus orci, praesent nec enim cras
                  facilisi. Curabitur eros viverra sem.</p>
              ...
              <div className="col-lg-5">
                <img src="/assets/images/extra/10.png" alt="image not found!" />
              </div>
            </div>
          </div>
        </div>
        {/*============================== How get service section end ==============================*/}
        {/*============================== How it work section start ==============================*/}
        <div className="full-row bg-light max-sm-bg-img-none" style={{backgroundImage: 'url(/assets/images/background/11.png)', backgroundRepeat: 'no-repeat', backgroundPosition: '40% center'}}>
          <div className="container">
            <div className="row">
              <div className="col-md-6 offset-md-6">
                <h2 className="mb-4 down-line-primary">How Work?</h2>
                <span className="sub-title fs-18 highlight-font fst-normal text-general text-start mb-30">Mauris primis turpis Laoreet magna felis mi amet quam enim curae. Sodales semper tempor dictum faucibus habitasse.</span>
                <div className="mb-4">
                  <h4 className="mb-3">Home and Office Security</h4>
                  <p>Tristique nam platea. Hendrerit iaculis turpis pharetra egestas sem orci. Tristique eget parturient lobortis. Maecenas lacinia iaculis sed netus vivamus gravida ad pretium tempor dolor tristique.</p>
                </div>
                <div className="mb-4">
                  <h4 className="mb-3">Biometric Security</h4>
                  <p>Tristique nam platea. Hendrerit iaculis turpis pharetra egestas sem orci. Tristique eget parturient lobortis. Maecenas lacinia iaculis sed netus vivamus gravida ad pretium tempor dolor tristique.</p>
                </div>
                <div className="mb-4">
                  <h4 className="mb-3">Document and File Security</h4>
                  <p>Tristique nam platea. Hendrerit iaculis turpis pharetra egestas sem orci. Tristique eget parturient lobortis. Maecenas lacinia iaculis sed netus vivamus gravida ad pretium tempor dolor tristique.</p>
                </div>
              </div>
            </div>
        ...
        {/*============================== Guarantee and Safety section end ==============================*/}
        <div className="full-row">
          <div className="container">
            <div className="row">
              <div className="col-lg-7">
                <h2 className="down-line-primary mb-4">Guarantee and Safety</h2>
                <p>Tristique nam platea. Hendrerit iaculis turpis pharetra egestas sem orci. Tristique eget parturient lobortis. Maecenas lacinia iaculis sed netus vivamus gravida ad pretium tempor dolor tristique. Accumsan at vitae dictum eget convallis
                  ut nulla ridiculus purus sollicitudin velit torquent penatibus mauris.</p>
                <p>Sodales gravida fermentum phasellus nonummy vulputate nec fermentum platea convallis potenti phasellus torquent lorem duis per sodales in scelerisque facilisi, at faucibus blandit suspendisse lacus orci, praesent nec enim cras
                  facilisi. Curabitur eros viverra sem.</p>
