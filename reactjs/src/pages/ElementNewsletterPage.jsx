export default function ElementNewsletterPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Newsletter</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Newsletter</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        {/*============================== Product Search Sample Start ==============================*/}
        <div className="py-5 bg-secondary">
          <div className="container">
            <div className="row gy-5">
              <div className="col-lg-4">
                <div className="outline-form-style-1 product-search-number">
                  <form className="form-outline square-shape" action="#" method="post">
                    <div className="input-full">
                      <input type="text" className="form-control input-field bg-light" name="search" placeholder="I’m shopping for" />
                      <button type="submit" name="submit" className="submit text-white bg-primary"><i className="fas fa-search" /></button>
                    </div>
                  </form>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="inline-form-style-1 product-search-number">
              ...
              <div className="col-lg-4">
                <div className="inline-form-style-1 product-search-number">
                  <form className="form-inline radius-shape" action="#" method="post">
                    <div className="input-group">
                      <input type="text" className="form-control input-field bg-light" name="search" placeholder="I’m shopping for" />
                      <button type="submit" name="submit" className="submit text-white bg-primary"><i className="fas fa-search" /></button>
                    </div>
              ...
              <div className="col-lg-4">
                <div className="inline-form-style-1 product-search-number">
                  <form className="form-inline pill-shape" action="#" method="post">
                    <div className="input-group">
                      <input type="text" className="form-control input-field bg-light" name="search" placeholder="I’m shopping for" />
                      <button type="submit" name="submit" className="submit text-white bg-primary"><i className="fas fa-search" /></button>
                    </div>
              ...
              <div className="col-lg-4">
                <div className="inline-form-style-1 product-search-number">
                  <form className="form-inline square-shape" action="#" method="post">
                    <div className="input-group">
                      <input type="text" className="form-control input-field bg-light" name="search" placeholder="I’m shopping for" />
                      <button type="submit" name="submit" className="submit text-primary bg-light"><i className="fas fa-search" /></button>
                    </div>
                  </form>
                </div>
              </div>
              ...
              <div className="col-lg-4">
                <div className="bg-primary p-3">
                  <div className="inline-form-style-1 product-search-number">
                    <form className="form-inline square-shape" action="#" method="post">
                      <div className="input-group">
                        <input type="text" className="form-control input-field bg-white" name="search" placeholder="Enter Your Email" />
                        <button type="submit" name="submit" className="submit text-dark bg-white"><i className="far fa-arrow-alt-circle-right" /></button>
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <div className="col-lg-4">
                <div className="inline-form-style-2 newsletter-number">
                  <form className="form-inline square-shape" action="#" method="post">
                    <div className="input-group">
                      <input type="text" className="form-control input-field bg-transparent" name="search" placeholder="Your e-Mail Address" />
                      <button type="submit" name="submit" className="submit text-white bg-primary">Subscribes</button>
                    </div>
                  </form>
                </div>
        ...
        {/*============================== Product Search Sample End ==============================*/}
        {/*============================== Product Search 1 Section Start ==============================*/}
            ...
            <div className="row justify-content-center gy-5">
              <div className="col-10">
                <div className="inline-form-style-1 product-search-number">
                  <form className="form-inline pill-shape" action="#" method="post">
                    <div className="input-group">
                      <input type="text" className="form-control input-field bg-white" name="search" placeholder="I’m shopping for" />
                      <button type="submit" name="submit" className="submit text-white bg-primary"><i className="fas fa-search" /></button>
                    </div>
                  </form>
                </div>
              ...
              <div className="col-10">
                <div className="inline-form-style-1 newsletter-number">
                  <form className="form-inline pill-shape" action="#" method="post">
                    <div className="input-group">
                      <input type="text" className="form-control input-field bg-white" name="search" placeholder="Your e-Mail Address" />
                      <button type="submit" name="submit" className="submit text-white bg-primary">Subscribes</button>
                    </div>
                  </form>
                </div>
        ...
        {/*============================== Product Search 1 Section End ==============================*/}
        {/*============================== Product Search 2 Section Start ==============================*/}
        <div className="full-row bg-white mt-5 p4-5">
          <div className="container">
        ...
        {/*============================== Product Search 2 Section End ==============================*/}
        {/*============================== Newsletter Section Start ==============================*/}
        <div className="full-row bg-primary newsletter-1 py-5 mt-5">
          <div className="container">
            <div className="row g-4">
              <div className="col-lg-6">
                <h1 className="title text-white">News Subscribes Now.</h1>
              </div>
              <div className="col-lg-5 offset-lg-1">
                <div className="inline-form-style-2 newsletter-number">
                  <form className="form-inline square-shape" action="#" method="post">
                    <div className="input-group">
                      <input type="text" className="form-control input-field bg-transparent text-white" name="search" placeholder="Your e-mail" />
                      <button type="submit" name="submit" className="submit text-primary bg-white">Subscribes</button>
                    </div>
                  </form>
                </div>
              </div>
        ...
        <div className="full-row bg-primary py-5 mt-5">
          <div className="container">
            <div className="row gy-3">
              <div className="col-lg-8 wow animate__animated animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                <h2 className="text-white mb-2">A Free Consultation and Business Tips 24/7</h2>
                <span className="text-white">If you interested in out theme don't wait to purchase or call us</span>
              </div>
              <div className="col-lg-4 wow animate__animated animate__fadeIn" data-wow-delay="200ms" data-wow-duration="1000ms">
                <div className="d-table ms-lg-auto position-relative y-center"><a href="#" className="btn btn-secondary rounded-0">Get Customer Support</a></div>
              </div>
            </div>
          </div>
        </div>
