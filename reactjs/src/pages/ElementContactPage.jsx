export default function ElementContactPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Contact</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Contact</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div className="row g-4">
              <div className="col-lg-8">
                <div className="bg-gray p-5">
                  <h2 className="mb-4 down-line-primary">Get In Touch</h2>
                  <span className="d-table mb-4 fs-18 fst-italic">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Your email sent Successfully.</span>
                  <form id="contact-form" className="contact_message" action="#" method="post">
                    <div className="row g-4">
                      <div className="col-md-6 col-sm-6">
                        <input className="form-control" id="name" name="firstname" placeholder="Name" type="text" />
                      </div>
                      <div className="col-md-6 col-sm-6">
                        <input className="form-control" id="email" name="email" placeholder="Email Address" type="text" />
                      </div>
                      <div className="col-md-12 col-sm-12">
                        <input className="form-control" id="subject" name="subject" placeholder="Subject" type="text" />
                      </div>
                      <div className="col-md-12 col-sm-12">
                        <textarea className="form-control" id="message" rows={5} name="message" placeholder="Message" defaultValue={""} />
                      </div>
                      <div className="col-md-4 col-sm-6">
                        <input className="btn btn-primary-filter form-control" id="send" defaultValue="Send Message" type="submit" />
                      </div>
              ...
              <div className="col-lg-4">
                <div className="contact-detail p-5 text-white bg-dark">
                  <h3 className="down-line-primary mb-4 text-white">Get In Touch</h3>
                  <span className="d-table mb-4 fs-18 fst-italic">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sit amet</span>
                  <div className="mb-4">
                    <span className="text-primary">Phone Number</span>
                    <p>(+1) 518-636-6052 <br /> (+1) 248-537-1825</p>
                  </div>
                  <div className="mb-4">
                    <span className="text-primary">E-Mail</span>
                    <p>Info@patron.com <br /> support@patron.com</p>
                  </div>
                  <div className="mb-4">
                    <span className="text-primary">Address</span>
                    <p>4214 Arlington Avenue Des Arc, AR 72040, USA</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/*============================== Contact section start ==============================*/}
        <div className="full-row gradient-bg-1">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 wow animate__animated animate__fadeIn" data-wow-delay="100ms" data-wow-duration="1000ms">
                <span className="tagline text-white text-uppercase text-center mb-10">World Wide Service</span>
                <h1 className="text-white text-center fw-600 mb-50">We have service everywhere</h1>
              </div>
            </div>
            <div className="row justify-content-center">
              <div className="col-lg-12">
                <div className="map mb-5">
                  <img src="/assets/images/extra/3.png" alt />
                </div>
              </div>
              <div className="col-lg-7 col-xl-6">
                <h3 className="text-white text-center mb-4">If starts with a domain, find a good one new</h3>
                <div className="inline-form-style-1 product-search-number">
                  <form className="form-inline pill-shape" action="#" method="post">
                    <div className="input-group">
                      <input type="text" className="form-control input-field bg-white" name="search" placeholder="Find your perfect domain name" />
                      <button type="submit" name="submit" className="submit text-general bg-white"><i className="fas fa-search" /></button>
                    </div>
                  </form>
                </div>
              </div>
