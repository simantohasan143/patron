export default function ElementProgressBarPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Progress Bar</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Progress Bar</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row justify-content-start">
              <div className="col-lg-6">
                <h3 className="text-secondary mb-40 text-left down-line">Thin Progress Bar </h3>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <div className="bar-progress progress-hight-3">
                  <div className="position-relative fact-counter text-secondary mb-20">
                    <span>WooCommerce</span>
                    <div className="progress count wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="500ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={70}>0</span>%</div>
                      <div className="progress-bar bg-success" aria-valuenow={70} aria-valuemax={100}> </div>
                    </div>
                  </div>
                  <div className="position-relative fact-counter text-secondary mb-20">
                    <span>User Friendly</span>
                    <div className="progress count wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="700ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={90}>0</span>%</div>
                      <div className="progress-bar bg-info" aria-valuenow={90} aria-valuemax={100}> </div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row justify-content-start mt-5">
              <div className="col-lg-6">
                <h3 className="text-secondary mb-40 text-left down-line">Strong Progress Bar</h3>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <div className="bar-progress progress-hight-15">
                  <div className="position-relative fact-counter text-secondary mb-20">
                    <span>WooCommerce</span>
                    <div className="progress count wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="500ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={70}>0</span>%</div>
            ...
            <div className="row justify-content-start mt-5">
              <div className="col-lg-6">
                <h3 className="text-secondary mb-40 text-left down-line">Strong Progress Bar Striped</h3>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <div className="bar-progress progress-hight-15">
                  <div className="position-relative fact-counter text-secondary mb-20">
                    ...
                    <div className="progress count wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="500ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={70}>0</span>%</div>
                      <div className="progress-bar progress-bar-striped bg-success" aria-valuenow={70} aria-valuemax={100}> </div>
                    </div>
                  </div>
                  <div className="position-relative fact-counter text-secondary mb-20">
                    <span>User Friendly</span>
                    <div className="progress count wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="700ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={90}>0</span>%</div>
                      <div className="progress-bar progress-bar-striped bg-info" aria-valuenow={90} aria-valuemax={100}> </div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row justify-content-start mt-5">
              <div className="col-lg-6">
                <h3 className="text-secondary mb-40 text-left down-line">Strong Progress Bar Striped Animated</h3>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <div className="bar-progress progress-hight-15">
                  <div className="position-relative fact-counter text-secondary mb-20">
                    ...
                    <div className="progress count wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="500ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={70}>0</span>%</div>
                      <div className="progress-bar progress-bar-striped progress-bar-animated bg-success" aria-valuenow={70} aria-valuemax={100}> </div>
                    </div>
                  </div>
                  <div className="position-relative fact-counter text-secondary mb-20">
                    <span>User Friendly</span>
                    <div className="progress count wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="700ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={90}>0</span>%</div>
                      <div className="progress-bar progress-bar-striped progress-bar-animated bg-info" aria-valuenow={90} aria-valuemax={100}> </div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row justify-content-start mt-5">
              <div className="col-lg-8">
                <h3 className="text-secondary mb-40 text-left down-line">Strong Progress Bar Striped Animated With Shadow</h3>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <div className="bar-progress progress-hight-15 shadow p-5">
                  <div className="position-relative fact-counter text-secondary mb-20">
                    <span>WooCommerce</span>
                    <div className="progress count rounded-0 wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="500ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={70}>0</span>%</div>
                      <div className="progress-bar progress-bar-striped progress-bar-animated bg-success" aria-valuenow={70} aria-valuemax={100} />
                    </div>
                  </div>
                  <div className="position-relative fact-counter text-secondary mb-20">
                    <span>User Friendly</span>
                    <div className="progress count wow animate__animated animate__fadeInUp animate__fast" data-wow-delay="700ms" data-wow-duration="300ms">
                      <div className="skill-percent"><span className="count-num" data-speed={3000} data-stop={90}>0</span>%</div>
                      <div className="progress-bar progress-bar-striped progress-bar-animated bg-info" aria-valuenow={90} aria-valuemax={100} />
                    </div>
                  </div>
                </div>
              </div>
