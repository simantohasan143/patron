export default function ElementBrandPage() {
  return (
    <>
      <div id="page-wrapper">
              ...
              <div className="col">
                <div className="d-flex flex-column gap-3" style={{padding: '70px 0'}}>
                  <div className="title-wrap">
                    <h1 className="page-title mb-0">Brand</h1>
                  </div>
                  <nav>
                    <ol className="breadcrumb mb-0 greater-than">
                      ...
                      <li className="breadcrumb-item"><span style={{color: '#6c757d'}} className="last">Brand</span></li>
                    </ol>
                  </nav>
                </div>
              </div>
        ...
        <div className="full-row bg-white pt-0">
          <div className="container">
            <div className="row row-cols-xl-4 row-cols-lg-4 row-cols-sm-3 row-cols-1 gy-5 mt-5">
              <div className="col">
            ...
            <div className="row mt-5">
              <div className="col-12">
                <div className="4block-carousel owl-carousel owl-nav-disable owl-dot-round owl-dot-bottom-center owl-dot-active-pill-primary autoplay-off">
                  <div className="item">
                    <a href="#" className="hover-img-upshow overflow-hidden d-inline-block">
                      <img src="/assets/images/partner/1.png" alt="partner logo" />
                    </a>
